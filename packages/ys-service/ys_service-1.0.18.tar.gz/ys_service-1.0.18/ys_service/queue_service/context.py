...
class Context(object):
    ...
    def log(self, message, level="info", data_property=None, version=None, auth=None,
        ...
        if not self.logger:
            ...
            trace_property = {
                ...
                "processStage": process_stage or self.header_frame.headers.get("process_stage")
            }
            if not self.logger:
    ...
    def local_log(self, msg, level="info", is_net=False, application_name=None, process_stage=None):
        ...
        if is_net:
            ...
            self._thread_pool.submit(self.log, arg_1, level=level, application_name=application_name, process_stage=process_stage)
