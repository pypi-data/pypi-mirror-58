...
class GetQueryResultsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetQueryResults.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/athena.html#Athena.Paginator.GetQueryResults.paginate)
        """
...
class ListNamedQueriesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListNamedQueries.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/athena.html#Athena.Paginator.ListNamedQueries.paginate)
        """
...
class ListQueryExecutionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListQueryExecutions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/athena.html#Athena.Paginator.ListQueryExecutions.paginate)
        """
