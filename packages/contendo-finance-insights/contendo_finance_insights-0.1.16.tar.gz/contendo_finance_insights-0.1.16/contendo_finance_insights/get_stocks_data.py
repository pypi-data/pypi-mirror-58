...
from contendo_finance_insights import FINANCE_GCP_BUCKET
...
class GetStocksData:
    ...
    def update_stock_data(self):
        _stocksQuery = """SELECT * FROM `sportsight-tests.Finance_Data.eod_daily_history_1year` order by Symbol, Date"""
        _targetDataset = 'temp'
