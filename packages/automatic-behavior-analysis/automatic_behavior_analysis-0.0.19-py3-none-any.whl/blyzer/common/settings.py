...
DEFAUL_SETTINGS = {
    ...
    "color_awake": [52, 152, 211],
    "color_sleep": [241, 176, 47],
    "color_unknown": [134, 89, 182],
    "max_detection_targets": 3,
    "video_extension": "mp4",
    "frame_processing_max_memory": 100,
    "media_source_type": "nnVideo",
...
class BlazesSettings(object):
    ...
    def setParam(self, key:str, value, force=False):
    ...
    def _load_setting(self):
        settigs_filename = BlazesSettings.get_settings_filename()
...
if __name__ == "__main__":
    ...
    print(BlazesSettings.get_settings_filename())
    blset = BlazesSettings().getParam("protocol")
    print(blset)
