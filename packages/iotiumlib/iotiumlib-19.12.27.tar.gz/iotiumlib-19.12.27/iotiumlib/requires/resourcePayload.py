...
class resourcePaylod(object):
    ...
    class Subscriptions(object):
        ...
        def __init__(self, payload):
            ...
            deliveryChannelObj = resourcePaylod.Subscriptions.DeliveryChannels()
            ...
            self.delivery_channels = [{"type": getattr(deliveryChannelObj, "type"), "settings": {"to": getattr(deliveryChannelObj.Settings(), "to")}}]
        ...
        class DeliveryChannels(object):
            ...
            class Settings(object):
                def __init__(self):
                    self._to = getattr(usernameObj, 'username')
