...
class Dataset(CnvrgFiles):
    ...
    def get_query(self, query_slug: AnyStr):
        return self._fetch_query(query_slug)
    ...
    def _fetch_query(self, query_slug: AnyStr):
        response = apis_helper.get(apis_helper.url_join(self.get_base_url(), "queries", query_slug))
        return response.get("files")
