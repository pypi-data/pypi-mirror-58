...
class SnakeSetup:
    ...
    def __init__(self, window: Window) -> None:
        ...
        self.score = 0
        self.timeout = 100
        self.control = ControlKey()
        self.direction = self.control.right
...
class TerminalSnake(Snake):
    ...
    def __init__(self, longitude: int, latitude: int, window: Window) -> None:
        ...
        self._body_list = list()
        self._body = lambda track: SnakeBody(long=longitude - track, lat=latitude)
        self._head = SnakeBody(long=longitude, lat=latitude, entity="O")
        self._last_head_location = (longitude, latitude)
        self._direction_map = {
    ...
    def score(self) -> str:
        return "Your Score : {}".format(self._setup.score)

    def eat(self, food: Food) -> None:
        food.reset()
        body = SnakeBody(*self._last_head_location)
    ...
    def update(self) -> None:
        last_body = self._body_list.pop(0)
