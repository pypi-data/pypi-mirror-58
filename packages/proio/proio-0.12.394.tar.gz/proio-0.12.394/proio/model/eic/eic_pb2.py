...
SimHit = _reflection.GeneratedProtocolMessageType('SimHit', (_message.Message,), {
  'DESCRIPTOR' : _SIMHIT,
  '__module__' : 'proio.model.eic.eic_pb2'
...
EnergyDep = _reflection.GeneratedProtocolMessageType('EnergyDep', (_message.Message,), {
...
KernelMatrix = _reflection.GeneratedProtocolMessageType('KernelMatrix', (_message.Message,), {
...
CaloShower = _reflection.GeneratedProtocolMessageType('CaloShower', (_message.Message,), {

  'ParticleHypothesis' : _reflection.GeneratedProtocolMessageType('ParticleHypothesis', (_message.Message,), {
...
TrackSegment = _reflection.GeneratedProtocolMessageType('TrackSegment', (_message.Message,), {
...
ObservedPos = _reflection.GeneratedProtocolMessageType('ObservedPos', (_message.Message,), {
...
RandVar = _reflection.GeneratedProtocolMessageType('RandVar', (_message.Message,), {
  'DESCRIPTOR' : _RANDVAR,
  '__module__' : 'proio.model.eic.eic_pb2'
