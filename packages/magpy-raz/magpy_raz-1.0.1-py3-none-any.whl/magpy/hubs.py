...
class Hubs:
    ...
    def __init__(self, gl, hubs, prefix):
        self.prefix = prefix
        self.events = []
        self.backlog = []
        self.sprint_items = []
    ...
    def write_csv_files(self):
        ...
        '''
        BacklogFile(self.prefix, self.backlog).write()
        EventFile(self.prefix, self.events).write()
        SprintFile(self.prefix, self.sprint_items).write()
