...
#    print('--- SigProfilerTopography Version:%s' % version.version)
 #   print("--- SigProfilerMatrixGenerator Version: %s" %matGen.__version__)
    #print("--- SigProfilerSimulator version: %s" %simulator.__version__)
...
def plotFigures(outputDir,jobname,numberofSimulations,sample_based,multipleTesting,probabilityCalculation,mutationTypes,epigenomics_files,epigenomics_files_memos,epig,enomics_biosamples,nucleosome_file,epigenomics,nucleosome,replication_time,strand_bias,processivity,plusOrMinus_epigenomics,plusOrMinus_nucleosome,verbose,DATA_IS_READY_PLOT_FIGURES):
...
if __name__== "__main__":
    ...
    runAnalyses(genome, inputDir, outputDir, jobname, numberofSimulations,
                          ...
                          id_probabilities_file_path=id_probabilities,
                           ...
                           computation_type='COMPUTATION_CHROMOSOMES_SEQUENTIAL_ALL_SIMULATIONS_PARALLEL',
                           epigenomics=False, nucleosome=False, replication_time=False, strand_bias=False, processivity=True,
