...
stem_version = {}
stem_version_path = pathlib.Path(__file__).parent / 'stem.version'
with open(stem_version_path) as fp:
    exec(fp.read(), stem_version)

__version__ = stem_version['__version__']
__author__ = stem_version['__author__']
__contact__ = stem_version['__contact__']
__url__ = stem_version['__url__']
__license__ = stem_version['__license__']
