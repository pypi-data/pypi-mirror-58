...
This variables for windows API's PostMessage and SendMessage.
parameters that massage commends:
  HWND(windows handle), Message ID, wParam, lParam 


WM_{} -> (Message ID, wParam, lParam )

"""
WM_CHAR = lambda key: (0x0102, key, 0x1)

def post_message(hwnd, msg: str):
    for m in msg:
        win32api.PostMessage(hwnd, 0x102, ord(m), 0x1)
