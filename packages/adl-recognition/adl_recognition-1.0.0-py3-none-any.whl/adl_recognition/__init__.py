...
def predict_continuous_adl(audio_file_path, depth_file_path, audio_start_timestamp, depth_start_timestamp,
    ...
    nr_audio, sample_rate, datetime_audio = audio_data.process_audio_data(audio_file_path, audio_start_timestamp)

    sil_model = model.get_model(sil_model_path)
    classifier_model = model.get_model(classifier_path)

    video, timestamps = depth_data.get_depth_video(depth_file_path, sil_model, depth_frame_height, depth_frame_width,
...
def predict_single_adl(audio_file_path, depth_file_path, audio_start_timestamp, depth_start_timestamp,
    ...
    video, time_stamps = depth_data.get_depth_video(depth_file_path, sil_model, depth_frame_height, depth_frame_width,
                                                    depth_start_timestamp, depth_end_timestamp)
