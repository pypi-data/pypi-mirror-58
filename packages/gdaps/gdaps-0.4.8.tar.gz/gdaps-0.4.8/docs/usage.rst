...
This creates a /frontend/ directory in the project root, and installs a frontend application there. The type of frontend depends on what you have selected in `GDAPS["FRONTEND_ENGINE"]`: Vue, PySide are available ATM.
