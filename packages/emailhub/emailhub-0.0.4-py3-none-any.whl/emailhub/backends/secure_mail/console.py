# -*- coding: utf-8 -*-
"""
EmailHub secure_mail console backend
"""
from secure_mail.backends import EncryptingConsoleEmailBackend  # noqa pylint: disable=import-error
from emailhub.utils.email import process_outgoing_email


class EmailBackend(EncryptingConsoleEmailBackend):
    """ Encrypting console backend """
