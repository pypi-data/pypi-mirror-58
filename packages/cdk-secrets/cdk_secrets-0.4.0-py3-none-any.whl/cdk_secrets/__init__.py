...
[AWS CDK](https://aws.amazon.com/de/cdk/) construct to manage secrets. It makes use of a custom resource provider from [binxio/cfn-secret-provider](https://github.com/binxio/cfn-secret-provider).
...
__jsii_assembly__ = jsii.JSIIAssembly.load("cdk-secrets", "0.4.0", __name__, "cdk-secrets@0.4.0.jsii.tgz")
