...
class MaskCheck(object):
    def __init__(self, path, maskpath, percent=1):
    ...
    def _crop(raw, mask):
        ...
        for i, j in zip([cz, cy, cx], mask.shape):
            right = i + cs // 2 - j
            if right > 0:
...
if __name__ == "__main__":
    ...
    nii = "/data/qingqing/2575003/1785074/2575003_1785074_Ax_LAVA+C__4_0_1_axial.nii"
    nrrd = "/data/qingqing/2575003/1785074/2575003_1785074_Ax_LAVA+C__4_0_1_axialART.nrrd"
    mask = MaskCheck(nii, nrrd)
    png = mask._plot()
