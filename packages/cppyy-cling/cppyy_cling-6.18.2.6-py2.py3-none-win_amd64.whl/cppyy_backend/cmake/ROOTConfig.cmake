...
#
set(ROOT_DEFINITIONS "-D_WINDOWS;-DWIN32;-D_AMD64_;-D_XKEYCHECK_H;-D_LIBCPP_HAS_NO_PRAGMA_SYSTEM_HEADER;-DNOMINMAX;-D_CRT_SECURE_NO_WARNINGS")
set(ROOT_CXX_FLAGS "-nologo -IC:/Users/wlav/Test/cppyy-backend/cling/src/build/win -FIw32pragma.h -FIsehmap.h -Zc:__cplusplus -MD -GR -D_WINDOWS -DWIN32 -D_AMD64_ -EHsc- -wd4141 -wd4291 -wd4244 -wd4049 -D_XKEYCHECK_H -D_LIBCPP_HAS_NO_PRAGMA_SYSTEM_HEADER -DNOMINMAX -D_CRT_SECURE_NO_WARNINGS ")
set(ROOT_C_FLAGS "-nologo -IC:/Users/wlav/Test/cppyy-backend/cling/src/build/win -FIw32pragma.h -FIsehmap.h -MD -D_WINDOWS -DWIN32 -D_AMD64_ -EHsc- -D_LIBCPP_HAS_NO_PRAGMA_SYSTEM_HEADER -DNOMINMAX ")
...
set(_root_enabled_options  builtin_clang builtin_freetype builtin_llvm builtin_pcre builtin_xxhash builtin_zlib cling explicitlink shared thread)
set(_root_all_options  alien arrow asimage astiff builtin_cfitsio builtin_clang builtin_davix builtin_fftw3 builtin_freetype builtin_gl2ps builtin_glew builtin_gsl builtin_llvm builtin_lz4 builtin_lzma builtin_openssl builtin_pcre builtin_tbb builtin_unuran builtin_vc builtin_vdt builtin_veccore builtin_xrootd builtin_xxhash builtin_zlib ccache cefweb clad cling cocoa coverage cuda cxxmodules davix dcache exceptions explicitlink fftw3 fitsio fortran gdml gfal gnuinstall gsl_shared gviz http imt jemalloc libcxx macos_native mathmore memory_termination memstat minuit2 monalisa mysql odbc opengl oracle pch pgsql pyroot_experimental pythia6_nolink pythia6 pythia8 python qt5web r roofit webgui root7 rpath runtime_cxxmodules shadowpw shared soversion sqlite ssl tcmalloc thread tmva tmva-cpu tmva-gpu tmva-pymva tmva-rmva unuran vc vmc vdt veccore vecgeom winrtdebug x11 xml xrootd)
