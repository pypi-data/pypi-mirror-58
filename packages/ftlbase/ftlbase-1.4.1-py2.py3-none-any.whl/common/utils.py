...
def has_permission(request, model, acao, permission, raise_exception=True):
    """ Return True if the user has the permission to add a model or false orraise exeption if enabled. """
