...
class BaseRestClient:
    ...
    MultipleObjectsReturned = type('MultipleObjectsReturned', (LookupError,), {})
    ...
    def detail(self, *args, **kwargs):
        ...
        return self.detail_from_envelope(response, response.json())
    ...
    def detail_from_envelope(self, response, envelope):
        return envelope
