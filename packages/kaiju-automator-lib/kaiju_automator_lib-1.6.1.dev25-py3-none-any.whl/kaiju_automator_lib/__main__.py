...
@runez.click.version()
@click.option(
    "--rae", type=str, required=True, help="The Netflix RAE device to connect to.", envvar="RAE",
)
@click.option(
    "--esn", type=str, help="The ESN of the target device. Mutually exclusive to ip and serial.", envvar="ESN",
)
@click.option(
    "--ip", type=str, help="The IP address of the target device. Mutually exclusive to esn and serial.", envvar="DUT_IP",
)
@click.option(
    "--serial", type=str, help="The serial number of the target device. Mutually exclusive to ip  and esn.", envvar="DUT_SERIAL",
)
@click.option(
    "--testplan", type=click.File("w"), required=True, help="The file to write the test plan to.",
)
...
@click.option(
    "--wait/--no-wait", default=True, help="Should this process block until tests are done?",
)
@click.option("--debug", is_flag=True, help="Show debugging information.")
@click.option("--log", is_flag=True, help="Log to file at given location.")
@click.option("--testplan", type=click.File("rb"), help="JSON formatted test plan file.")
@click.option("--cancel", is_flag=True, help="Cancel any pending run instead of starting tests.")
@runez.click.log()
