...
class AlarmExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [AlarmExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.44/reference/services/cloudwatch.html#CloudWatch.Waiter.AlarmExists.wait)
        """
