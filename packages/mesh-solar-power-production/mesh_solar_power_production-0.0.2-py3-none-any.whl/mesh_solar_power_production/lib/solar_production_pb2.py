...
_FEEDHEADER_INCREMENTALITY = _descriptor.EnumDescriptor(
  name='Incrementality',
  full_name='solar_production.FeedHeader.Incrementality',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_FEEDHEADER = _descriptor.Descriptor(
  name='FeedHeader',
  full_name='solar_production.FeedHeader',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='version', full_name='solar_production.FeedHeader.version', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='incrementality', full_name='solar_production.FeedHeader.incrementality', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='solar_production.FeedHeader.timestamp', index=2,
...
FeedMessage = _reflection.GeneratedProtocolMessageType('FeedMessage', (_message.Message,), dict(
  ...
  __module__ = 'solar_production_pb2'
...
PowerGenerationParameters = _reflection.GeneratedProtocolMessageType('PowerGenerationParameters', (_message.Message,), dict(
...
PhaseComponents = _reflection.GeneratedProtocolMessageType('PhaseComponents', (_message.Message,), dict(
...
SolarPanelGroup = _reflection.GeneratedProtocolMessageType('SolarPanelGroup', (_message.Message,), dict(
...
ElectricComponents = _reflection.GeneratedProtocolMessageType('ElectricComponents', (_message.Message,), dict(
