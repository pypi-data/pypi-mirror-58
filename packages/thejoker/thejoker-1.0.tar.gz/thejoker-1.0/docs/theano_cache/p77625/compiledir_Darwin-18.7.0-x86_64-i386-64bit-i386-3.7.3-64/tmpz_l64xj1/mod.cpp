...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m0d8a3a1983451a3abdffe5e507dee37b7758cd8e77650a383650e76f54b7f5ab {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m0d8a3a1983451a3abdffe5e507dee37b7758cd8e77650a383650e76f54b7f5ab() {
        ...
        ~__struct_compiled_op_m0d8a3a1983451a3abdffe5e507dee37b7758cd8e77650a383650e76f54b7f5ab(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m0d8a3a1983451a3abdffe5e507dee37b7758cd8e77650a383650e76f54b7f5ab_executor(__struct_compiled_op_m0d8a3a1983451a3abdffe5e507dee37b7758cd8e77650a383650e76f54b7f5ab *self) {
            return self->run();
        }

        static void __struct_compiled_op_m0d8a3a1983451a3abdffe5e507dee37b7758cd8e77650a383650e76f54b7f5ab_destructor(PyObject *capsule) {
            __struct_compiled_op_m0d8a3a1983451a3abdffe5e507dee37b7758cd8e77650a383650e76f54b7f5ab *self = (__struct_compiled_op_m0d8a3a1983451a3abdffe5e507dee37b7758cd8e77650a383650e76f54b7f5ab *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m0d8a3a1983451a3abdffe5e507dee37b7758cd8e77650a383650e76f54b7f5ab* struct_ptr = new __struct_compiled_op_m0d8a3a1983451a3abdffe5e507dee37b7758cd8e77650a383650e76f54b7f5ab();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m0d8a3a1983451a3abdffe5e507dee37b7758cd8e77650a383650e76f54b7f5ab_executor), NULL, __struct_compiled_op_m0d8a3a1983451a3abdffe5e507dee37b7758cd8e77650a383650e76f54b7f5ab_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m0d8a3a1983451a3abdffe5e507dee37b7758cd8e77650a383650e76f54b7f5ab",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m0d8a3a1983451a3abdffe5e507dee37b7758cd8e77650a383650e76f54b7f5ab(void) {
   import_array();
