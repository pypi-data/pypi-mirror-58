...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m652f037facc2ded51a9c44c0bf794ba92248cf03e62d6b1a4003ea6456c94416 {
        PyObject* __ERROR;
...
PyObject* storage_V7;
    ...
    PyObject* py_V7;
        ...
        __struct_compiled_op_m652f037facc2ded51a9c44c0bf794ba92248cf03e62d6b1a4003ea6456c94416() {
        ...
        ~__struct_compiled_op_m652f037facc2ded51a9c44c0bf794ba92248cf03e62d6b1a4003ea6456c94416(void) {
            cleanup();
        }
...
// Op class MaxAndArgmax
        ...
        if (PyTuple_GET_SIZE(V7) == PyArray_NDIM(V3)) {
            axis = NPY_MAXDIMS;
        } else if(PyTuple_GET_SIZE(V7) == 1) {
            PyObject* axis_object = PyTuple_GET_ITEM(V7, 0);
        ...
        V5 = (PyArrayObject*)PyArray_Max(V3, axis, NULL);
        if (V5 == NULL) {
            {
        __failure = 9;
        if (!PyErr_Occurred()) {
        ...
        if (!PyArray_CheckExact(V5)) {
            V5 = (PyArrayObject*)PyArray_FromAny((PyObject*)V5, NULL, 0, 0, NPY_ARRAY_ENSUREARRAY, NULL);
            if(V5 == NULL){
                {
        __failure = 9;
        if (!PyErr_Occurred()) {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m652f037facc2ded51a9c44c0bf794ba92248cf03e62d6b1a4003ea6456c94416_executor(__struct_compiled_op_m652f037facc2ded51a9c44c0bf794ba92248cf03e62d6b1a4003ea6456c94416 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m652f037facc2ded51a9c44c0bf794ba92248cf03e62d6b1a4003ea6456c94416_destructor(PyObject *capsule) {
            __struct_compiled_op_m652f037facc2ded51a9c44c0bf794ba92248cf03e62d6b1a4003ea6456c94416 *self = (__struct_compiled_op_m652f037facc2ded51a9c44c0bf794ba92248cf03e62d6b1a4003ea6456c94416 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m652f037facc2ded51a9c44c0bf794ba92248cf03e62d6b1a4003ea6456c94416* struct_ptr = new __struct_compiled_op_m652f037facc2ded51a9c44c0bf794ba92248cf03e62d6b1a4003ea6456c94416();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m652f037facc2ded51a9c44c0bf794ba92248cf03e62d6b1a4003ea6456c94416_executor), NULL, __struct_compiled_op_m652f037facc2ded51a9c44c0bf794ba92248cf03e62d6b1a4003ea6456c94416_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m652f037facc2ded51a9c44c0bf794ba92248cf03e62d6b1a4003ea6456c94416",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m652f037facc2ded51a9c44c0bf794ba92248cf03e62d6b1a4003ea6456c94416(void) {
   import_array();
