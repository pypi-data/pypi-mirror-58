...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m11cbc4e7021d6d9ba6081b570850007b6e45a9bed9cf8d04238e58b0ee5f6281 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m11cbc4e7021d6d9ba6081b570850007b6e45a9bed9cf8d04238e58b0ee5f6281() {
        ...
        ~__struct_compiled_op_m11cbc4e7021d6d9ba6081b570850007b6e45a9bed9cf8d04238e58b0ee5f6281(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m11cbc4e7021d6d9ba6081b570850007b6e45a9bed9cf8d04238e58b0ee5f6281_executor(__struct_compiled_op_m11cbc4e7021d6d9ba6081b570850007b6e45a9bed9cf8d04238e58b0ee5f6281 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m11cbc4e7021d6d9ba6081b570850007b6e45a9bed9cf8d04238e58b0ee5f6281_destructor(PyObject *capsule) {
            __struct_compiled_op_m11cbc4e7021d6d9ba6081b570850007b6e45a9bed9cf8d04238e58b0ee5f6281 *self = (__struct_compiled_op_m11cbc4e7021d6d9ba6081b570850007b6e45a9bed9cf8d04238e58b0ee5f6281 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m11cbc4e7021d6d9ba6081b570850007b6e45a9bed9cf8d04238e58b0ee5f6281* struct_ptr = new __struct_compiled_op_m11cbc4e7021d6d9ba6081b570850007b6e45a9bed9cf8d04238e58b0ee5f6281();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m11cbc4e7021d6d9ba6081b570850007b6e45a9bed9cf8d04238e58b0ee5f6281_executor), NULL, __struct_compiled_op_m11cbc4e7021d6d9ba6081b570850007b6e45a9bed9cf8d04238e58b0ee5f6281_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m11cbc4e7021d6d9ba6081b570850007b6e45a9bed9cf8d04238e58b0ee5f6281",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m11cbc4e7021d6d9ba6081b570850007b6e45a9bed9cf8d04238e58b0ee5f6281(void) {
   import_array();
