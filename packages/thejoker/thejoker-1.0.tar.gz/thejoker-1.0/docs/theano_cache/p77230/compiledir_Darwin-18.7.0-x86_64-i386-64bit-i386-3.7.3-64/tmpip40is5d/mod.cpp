...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m8d24deab84274767198cce0bd6c59a7a31f76918eb9fb5664045c209e7a8563c {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m8d24deab84274767198cce0bd6c59a7a31f76918eb9fb5664045c209e7a8563c() {
        ...
        ~__struct_compiled_op_m8d24deab84274767198cce0bd6c59a7a31f76918eb9fb5664045c209e7a8563c(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m8d24deab84274767198cce0bd6c59a7a31f76918eb9fb5664045c209e7a8563c_executor(__struct_compiled_op_m8d24deab84274767198cce0bd6c59a7a31f76918eb9fb5664045c209e7a8563c *self) {
            return self->run();
        }

        static void __struct_compiled_op_m8d24deab84274767198cce0bd6c59a7a31f76918eb9fb5664045c209e7a8563c_destructor(PyObject *capsule) {
            __struct_compiled_op_m8d24deab84274767198cce0bd6c59a7a31f76918eb9fb5664045c209e7a8563c *self = (__struct_compiled_op_m8d24deab84274767198cce0bd6c59a7a31f76918eb9fb5664045c209e7a8563c *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m8d24deab84274767198cce0bd6c59a7a31f76918eb9fb5664045c209e7a8563c* struct_ptr = new __struct_compiled_op_m8d24deab84274767198cce0bd6c59a7a31f76918eb9fb5664045c209e7a8563c();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m8d24deab84274767198cce0bd6c59a7a31f76918eb9fb5664045c209e7a8563c_executor), NULL, __struct_compiled_op_m8d24deab84274767198cce0bd6c59a7a31f76918eb9fb5664045c209e7a8563c_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m8d24deab84274767198cce0bd6c59a7a31f76918eb9fb5664045c209e7a8563c",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m8d24deab84274767198cce0bd6c59a7a31f76918eb9fb5664045c209e7a8563c(void) {
   import_array();
