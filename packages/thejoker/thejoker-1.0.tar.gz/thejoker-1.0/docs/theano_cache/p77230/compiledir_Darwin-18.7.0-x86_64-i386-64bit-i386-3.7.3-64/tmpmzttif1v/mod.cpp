...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m8c069144b5f30d54b9503198a3df441f1812ba0b68c6d0a422960bbfd480914f {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m8c069144b5f30d54b9503198a3df441f1812ba0b68c6d0a422960bbfd480914f() {
        ...
        ~__struct_compiled_op_m8c069144b5f30d54b9503198a3df441f1812ba0b68c6d0a422960bbfd480914f(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m8c069144b5f30d54b9503198a3df441f1812ba0b68c6d0a422960bbfd480914f_executor(__struct_compiled_op_m8c069144b5f30d54b9503198a3df441f1812ba0b68c6d0a422960bbfd480914f *self) {
            return self->run();
        }

        static void __struct_compiled_op_m8c069144b5f30d54b9503198a3df441f1812ba0b68c6d0a422960bbfd480914f_destructor(PyObject *capsule) {
            __struct_compiled_op_m8c069144b5f30d54b9503198a3df441f1812ba0b68c6d0a422960bbfd480914f *self = (__struct_compiled_op_m8c069144b5f30d54b9503198a3df441f1812ba0b68c6d0a422960bbfd480914f *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m8c069144b5f30d54b9503198a3df441f1812ba0b68c6d0a422960bbfd480914f* struct_ptr = new __struct_compiled_op_m8c069144b5f30d54b9503198a3df441f1812ba0b68c6d0a422960bbfd480914f();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m8c069144b5f30d54b9503198a3df441f1812ba0b68c6d0a422960bbfd480914f_executor), NULL, __struct_compiled_op_m8c069144b5f30d54b9503198a3df441f1812ba0b68c6d0a422960bbfd480914f_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m8c069144b5f30d54b9503198a3df441f1812ba0b68c6d0a422960bbfd480914f",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m8c069144b5f30d54b9503198a3df441f1812ba0b68c6d0a422960bbfd480914f(void) {
   import_array();
