...
class PredictionDataset(APIObject):
    ...
    predictions_start_date : datetime.datetime or None, optional
        Only specified in time series projects. The start date for bulk predictions. Note that this
    ...
    predictions_end_date : datetime.datetime or None, optional
        Only specified in time series projects. The end date for bulk predictions. Note that this
        parameter is for generating historical predictions using the training data. This parameter
        should be provided in conjunction with predictions_start_date. Can't be provided with the
        forecastPoint parameter.
    ...
    data_quality_warnings : dict, optional
        (New in version 2.15) A dictionary that contains available warnings about potential
