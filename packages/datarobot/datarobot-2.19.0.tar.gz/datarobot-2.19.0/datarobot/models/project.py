...
class Project(APIObject):
    ...
    def set_target(self, target,
        ...
        to it. Optionally begins generation of models.
    ...
    def get_association_featurelists(self):
        ...
        """
        url = '{}{}/featureAssocationFeaturelists/'.format(self._path, self.id)
    ...
    def train_datetime(self, blueprint_id, featurelist_id=None,
        ...
        monotonic_increasing_featurelist_id : str, optional
            (new in version 2.18) optional, the id of the featurelist that defines
