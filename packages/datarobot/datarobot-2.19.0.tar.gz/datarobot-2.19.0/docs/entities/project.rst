...
Create a Project
****************
You can use the following command to create a new project. You must specify a path to data file, file object URL (starting with ``http://``, ``https://``, ``file://``, or ``s3://``), raw file contents,
