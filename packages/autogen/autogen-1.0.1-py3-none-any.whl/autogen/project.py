...
class Project:
    ...
    def create_setup(self):
        ...
        try:
            ...
            raise Exception("Markers are missing from edit section. Replace\n"
    ...
    def description(self):
        ...
        try:
            readme = [f for f in os.listdir(os.getcwd())
                      if f.lower().startswith("readme")][0]
    ...
    def install_requires(self):
        ...
        # bug in pipreqs includes .egg files from local install
        requires = [r for r in requires if not r.endswith(".egg")]

        # other packages not needed
        requires = [r for r in requires if r not in ["setuptools"]]
    ...
    def package_data(self):
        ...
        for folder in folders:
            ...
            package_files = [f for f in package_files if os.path.isfile(f)
