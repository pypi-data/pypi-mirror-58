...
__all__ = ['InstanceNorm','BatchNorm','BatchNorm2d','BatchNorm3d','GroupNorm','GroupNorm2d','GroupNorm3d','get_normalization']
...
class BatchNorm(tf.keras.layers.BatchNormalization):
    def __init__(self,  momentum=0.1, affine=True, track_running_stats=True, **kwargs):
        """
        ...
        super(BatchNorm, self).__init__(axis=-1, momentum=momentum, epsilon=_epsilon, center=affine, scale=affine, beta_initializer='zeros', gamma_initializer='ones', moving_mean_initializer='zeros', moving_variance_initializer='ones',**kwargs)
