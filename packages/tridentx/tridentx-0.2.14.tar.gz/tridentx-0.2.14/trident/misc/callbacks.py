...
class EarlyStoppingCriterionCallback(StoppingCriterionCallback):
    ...
    def on_metrics_evaluation_end(self, training_context):
        ...
        best_results = training_context['_results_history'][self._best_epoch][self._evaluation_data_loader_key][self._evaluator_key]
        current_results = training_context['_results_history'][current_epoch][self._evaluation_data_loader_key][self._evaluator_key]
