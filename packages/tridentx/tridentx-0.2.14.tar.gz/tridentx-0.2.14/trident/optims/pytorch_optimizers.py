...
__all__ = ['Adam','SGD','Adadelta','Adagrad','RMSprop','RAdam','PlainRAdam','AdamW','Lookahead','Ranger','get_optimizer']

class Adam(optim.Adam,OptimizerMixin):
    pass
class SGD(optim.SGD,OptimizerMixin):
    pass

class Adadelta(get_class('Adadelta',['torch.optim']),OptimizerMixin):
    pass

class Adagrad(get_class('Adagrad',['torch.optim']),OptimizerMixin):
    pass

class RMSprop(get_class('RMSprop',['torch.optim']),OptimizerMixin):
    pass
