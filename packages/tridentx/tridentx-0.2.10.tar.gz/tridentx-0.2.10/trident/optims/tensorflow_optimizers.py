...
__all__ = ['Adam','RMSprop','SGD','Adagrad','Adadelta','RAdam','Lookahead','get_optimizer']


class Adam(tf.keras.optimizers.Adam.Adam,OptimizerMixin):
...
class RMSprop(tf.keras.optimizers.RMSprop,OptimizerMixin):
    def get_value(self,x):
        return tf.keras.backend.get_value(x)
    def set_value(self,x):
        return tf.keras.backend.set_value(x)
...
class SGD(tf.keras.optimizers.SGD,OptimizerMixin):
    def get_value(self,x):
        return tf.keras.backend.get_value(x)
    def set_value(self,x):
        return tf.keras.backend.set_value(x)
...
class Adagrad(tf.keras.optimizers.Adagrad,OptimizerMixin):
    def get_value(self,x):
        return tf.keras.backend.get_value(x)
    def set_value(self,x):
        return tf.keras.backend.set_value(x)
    pass
class Adadelta(tf.keras.optimizers.Adadelta,OptimizerMixin):
    def get_value(self,x):
        return tf.keras.backend.get_value(x)
    def set_value(self,x):
        return tf.keras.backend.set_value(x)
...
@register_keras_custom_object
class Lookahead(tf.keras.optimizers.Optimizer,OptimizerMixin):
...
def get_optimizer(optimizer_name):
    if optimizer_name is None:
        return None
    optimizer_modules = ['trident.optims.tensorflow_optimizers','tf.keras.optims']
