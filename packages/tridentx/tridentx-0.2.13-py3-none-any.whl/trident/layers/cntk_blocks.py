...
def Conv2d_Block(kernel_size=(3, 3), num_filters=32, strides=1, auto_pad=True, activation='relu6',
                 ...
                 dropout_rate=0):
    def internal_op(x):
        return conv2d_block(x, kernel_size=(3, 3), num_filters=32, strides=1, auto_pad=True, activation='relu6',
                            normalization='instance', use_bias=False, dilation=1, groups=1, add_noise=False,
                            noise_intensity=0.005, dropout_rate=0)
