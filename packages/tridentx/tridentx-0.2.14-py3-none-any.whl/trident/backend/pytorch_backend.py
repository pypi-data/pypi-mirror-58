...
import numpy as np
from .common import to_list,addindent,camel2snake,snake2camel

__all__ = ['to_numpy','to_tensor','print_network','plot_tensor_grid','summary','calculate_flops', 'Layer', 'Sequential', 'Input', 'ShortcutContainer', 'ConcatContainer', 'get_device', 'load']
...
class Layer(nn.Module):
    ...
    def __init__(self,**kwargs):
        ...
        if not name:
            ...
            name = camel2snake(prefix) + '_' + str(get_uid(prefix))
        self.name = name
    ...
    #             module.input_shape=to_numpy(input[0]).shape[1:]
    #
