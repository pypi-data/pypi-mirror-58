...
add("spectra_lexer.gui_none", "console", "Run commands interactively from console.")
add("spectra_lexer.gui_none", "index",   "Analyze a translations file and index each one by the rules it uses.")
