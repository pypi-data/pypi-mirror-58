...
@MenuManage.describ('pro.change_socialdeclaration', FORMTYPE_NOMODAL, 'microbusiness', _('Management of social declarations'))
...
@MenuManage.describ('pro.change_socialdeclaration')
