#######################################
#
# File: 08normalMixtureControlVariate.py
...
TRAIN_TT_SCALED = \
  DefineVariable('TRAIN_TT_SCALED', TRAIN_TT / 100.0)
TRAIN_COST_SCALED = \
  DefineVariable('TRAIN_COST_SCALED', TRAIN_COST / 100)
...
# Recycle the uniform draws used to generate the 
#normal draws of B_TIME_RND
UNIFDRAW = bioRecycleDraws('B_TIME_RND')

# Utility function with the uniform draws instead of the normal. 
VCV = ASC_TRAIN + \
      (B_TIME + B_TIME_S * UNIFDRAW) * TRAIN_TT_SCALED + \
      B_COST * TRAIN_COST_SCALED
# The analytical integral of exp(VCV) between 0 and 1 
# is now calculated
VCV_ZERO = ASC_TRAIN + \
