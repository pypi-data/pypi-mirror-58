#######################################
#
# File: 13estimationAntithetic_250.py
# Author: Michel Bierlaire, EPFL
# Date: Thu Jul 30 15:31:32 2015
#
#######################################
...
B_TIME_S = Beta('B_TIME_S',9,-10,10,0)
...
prob_plus = MonteCarlo(integrand_plus)
prob_minus = MonteCarlo(integrand_minus)
prob = 0.5 * (prob_plus + prob_minus)
...
BIOGEME_OBJECT.PARAMETERS['NbrOfDraws'] = "250"
