...
ASC_CAR = Beta('ASC_CAR',-0.112,-1,1,0)
ASC_TRAIN = Beta('ASC_TRAIN',-0.655,-1,1,0)
ASC_SM = Beta('ASC_SM',0,None,None,1)
B_TIME = Beta('B_TIME',0.259,-1,1,0)
B_TIME_S = Beta('B_TIME_S',0.473,-1,1,0)
B_COST = Beta('B_COST',-1.11,-2,1,0)
...
class test_17(unittest.TestCase):
    def testEstimation(self):
        ...
        biogeme.modelName = "test_17integral"
        results = biogeme.estimate(algorithm=None)
        self.assertAlmostEqual(results.data.logLike,-5234.59912667797,2)
