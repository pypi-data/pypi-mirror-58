...
from biogeme.expressions import Beta, DefineVariable, RandomVariable, Integrate, PanelLikelihoodTrajectory, log
import unittest
...
class test_12integral(unittest.TestCase):
    def testEstimation(self):
        ...
        biogeme.modelName = "test_12integral"
        results = biogeme.estimate(algorithm=None)
        self.assertAlmostEqual(results.data.logLike,-4373.481997547806,2)
