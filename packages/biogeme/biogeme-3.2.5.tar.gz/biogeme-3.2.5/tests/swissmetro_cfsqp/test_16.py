...
from biogeme.expressions import Beta, DefineVariable, bioDraws, MonteCarlo, exp, log, PanelLikelihoodTrajectory
import unittest
...
W_MALE = Beta('W_MALE',0,0,1,0)
cm = {1: 0, 2: W_OTHER + W_MALE * MALE}

probClass1 = exp(models.loglogit(cm,av=None,i=1))
probClass2 = exp(models.loglogit(cm,av=None,i=2))
...
class test_16(unittest.TestCase):
    def testEstimation(self):
        ...
        biogeme.modelName = "test_16"

        #        with self.assertRaises(RuntimeError):

        results = biogeme.estimate(algorithm=None)
        self.assertAlmostEqual(results.data.logLike,-4089.166674340407,2)
