...
from biogeme.expressions import Beta, DefineVariable, bioDraws, MonteCarlo, exp, log
import unittest
...
class test_06(unittest.TestCase):
    def testEstimation(self):
        ...
        biogeme.modelName = "test_06"
        results = biogeme.estimate(algorithm=None)
        self.assertAlmostEqual(results.data.logLike,-5308.187022430466,2)
