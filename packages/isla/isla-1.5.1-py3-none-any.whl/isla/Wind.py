...
class Wind(IntermittentComponent):
    ...
    def mc_prof(self, mo_ave):
        ...
        spd_yr = 2*np.average(mo_ave)*np.sqrt(-np.log(1-cdf_trn)/np.pi)
    ...
    def update_init(self):
        ...
        # extract dataset
        self.wd_spd = self._data_proc('wd_spd', True, self.spd_pin)
        self.wd_dir = self._data_proc('wd_dir', False, self.dir_pin)
