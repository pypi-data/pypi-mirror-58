...
def main():
    ...
    url = change_url(opts, jira_url=config["url"])
    file = file_name(opts)
    ...
    try:
        content = changelog(
            ...
            show=show, url=url, file=file, template=change_template(opts, config),
