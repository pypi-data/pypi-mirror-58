...
class Yundama:
    ...
    def __sign(self):
        return self.__md5(self.app_id + self.timestamp + self.__md5(self.timestamp + self.app_key))

    def __asign(self):
        return self.__md5(self.app_key + self.timestamp + self.__md5(self.timestamp + self.app_id))

    def __csign(self, card_id, card_key):
        return self.__md5(self.app_key + self.timestamp + card_id + card_key)
