...
class ListCertificateAuthoritiesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListCertificateAuthorities.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/acm-pca.html#ACMPCA.Paginator.ListCertificateAuthorities.paginate)
        """
...
class ListPermissionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListPermissions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/acm-pca.html#ACMPCA.Paginator.ListPermissions.paginate)
        """
...
class ListTagsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListTags.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/acm-pca.html#ACMPCA.Paginator.ListTags.paginate)
        """
