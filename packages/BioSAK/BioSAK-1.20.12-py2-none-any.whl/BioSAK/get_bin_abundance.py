...
BioSAK get_bin_abundance -sam combined_bins.sam -bin all_bins -x fa

# get abundance of customized bin clusters
BioSAK get_bin_abundance -sam combined_bins.sam -bin all_bins -x fa -out cluster_abundance.txt -cluster bin_cluster.txt

# get abundance of dRep produced bin clusters
BioSAK get_bin_abundance -sam combined_bins.sam -bin all_bins -x fa -out cluster_abundance.txt -Cdb Cdb.csv
