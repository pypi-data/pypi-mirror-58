...
def run_service(run_port=50188, class_name='py_help.cli.router.Router', is_gevent=False, worker_id=0,
    ...
    info(
        "开始启动 router backend_task service module_name:[{}],class_name:[{}],shared_dict:{},shared_queue_list:{}".format(
            module_name,
            class_name,
            len(shared_dict), len(shared_queue_list)))
