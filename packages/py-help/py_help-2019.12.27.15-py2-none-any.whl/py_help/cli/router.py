...
class Router(object):
    ...
    @classmethod
    def start_backend_task_daemon(cls, start_port=56788, proc_cnt=3, is_gevent=False):
        ...
        if cls.backend_task_monitor_thread is None:
            cls.backend_task_monitor_thread = TaskProcessMonitor(start_port, proc_cnt, cls, is_gevent)
