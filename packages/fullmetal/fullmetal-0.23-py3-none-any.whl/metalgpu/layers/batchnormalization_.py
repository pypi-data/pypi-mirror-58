...
class BatchNormalization(Layer):
    ...
    def initialize(self, optimizer):
        ...
        self.gamma = Parameter(cp.ones(self.icput_shape))
        self.beta = Parameter(cp.zeros(self.icput_shape))
    ...
    def grad_x_batchNorm(self, grad):
        ...
        # The gradient of the loss with respect to the layer icputs (use weights and statistics from forward pass)
