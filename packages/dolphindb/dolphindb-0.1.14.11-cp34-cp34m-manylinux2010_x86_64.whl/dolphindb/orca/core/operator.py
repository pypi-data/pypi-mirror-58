...
# def _is_op_on_different_columns(expr):
#     from orca.core.series import Series

#     if expr.is_dataframe_like:
#         return False

#     def is_const(expr):
#         return expr is None or isinstance(expr, (_ConstantSP, Timestamp))

#     def get_base_data_column(expr):
#         assert not is_const(expr)
#         if isinstance(expr, Series):
#             return expr._data_columns[0]
#         else:
#             left, right = expr._left, expr._right
#             if is_const(left):
#                 return get_base_data_column(right)
#             elif is_const(right):
#                 return get_base_data_column(left)
#             else:
#                 left_base_data_column = get_base_data_column(left)
#                 if left_base_data_column is False:
#                     return False
#                 right_base_data_column = get_base_data_column(right)
#                 if right_base_data_column is False:
#                     return False
#                 if left_base_data_column != right_base_data_column:
#                     return False
#                 return left_base_data_column

#     return get_base_data_column(expr) is False
