...
def _generate_joiner(left_var_name, right_var_name,
        ...
        if how == "right":
            from_clause = f"{method}({right_var_name} as {right_var_name}, " \
                          f"{left_var_name} as {left_var_name}, " \
                          f"{right_join_literal}, {left_join_literal})"
        else:
            from_clause = f"{method}({left_var_name} as {left_var_name}, " \
                          f"{right_var_name} as {right_var_name}, " \
