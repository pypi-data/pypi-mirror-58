...
class ListJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListJobs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/glacier.html#Glacier.Paginator.ListJobs.paginate)
        """
...
class ListMultipartUploadsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListMultipartUploads.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/glacier.html#Glacier.Paginator.ListMultipartUploads.paginate)
        """
...
class ListPartsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListParts.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/glacier.html#Glacier.Paginator.ListParts.paginate)
        """
...
class ListVaultsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListVaults.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/glacier.html#Glacier.Paginator.ListVaults.paginate)
        """
