...
class FeaturesAssembler(AbstractAssembler):
    ...
    def assembleFeature(self, feature_type, n_past_features):
        ...
        if (feature_type is not features_type.FeaturesType.HISTORY or feature_type is not features_type.FeaturesType.HISTORY_ADVANCED) and n_past_features is not None:
            return

        if (feature_type is not features_type.FeaturesType.STANDARD or feature_type is not features_type.FeaturesType.STANDARD_ADVANCED) and n_past_features is None:
            return
