...
class FeaturesAssembler(AbstractAssembler):
    ...
    def assembleFeature(self, feature_type, n_past_features):
        ...
        print('saving file')
        features_saving_path = self.root  + self.user + '_' + str(features_type) + '_' + str(n_past_features) + self.features_saving_path
        print(features_saving_path)
        np.save(features_saving_path, features)

        features_names_saving_path = self.root  + self.user + '_' + str(features_type) + '_' + str(n_past_features) + self.features_names_saving_path
