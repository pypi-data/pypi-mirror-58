...
setup(
    ...
    version="0.2.1",                  # 版本，每次发版本都不能重复，每次发版必须改这个地方
    description=(
        'Simple python lib, processing csv,excel,mail,textgrid,metadata,wav; using for SurfingTech or others'   # 一个简介，别人搜索包时候，这个概要信息会显示在在搜索列表中
    ...
    packages=['kog_lib.excel','kog_lib.mail','kog_lib.textgrid','kog_lib.metadata','kog_lib.wav'],
    platforms=["all"],
