...
class SFMetadata:
    ...
    def help():
        print("""
        ------------SFMetadata类 使用方法---------------------------------------------
        from kog_lib.metadata import sf_metadata\n
        实例化: 
            my_metadata = sf_metadata.SFMetadata()
...
# m = SFMetadata()
# m.load_template("E:/surfingwork/纯英文处理/20190826导出入库/20180100P00010i0001.metadata")
# m.set_metadata_element("SCD","DLSJFKLSADJFKLAJSDFSDF SDFSDF")
# m.make_metadata("./2.metadata")
# print(m.get_metadata_element("SCC"))
# m.help()
