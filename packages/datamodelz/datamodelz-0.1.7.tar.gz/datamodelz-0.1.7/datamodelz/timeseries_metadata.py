...
from .consts import frequencies, id_string, calculated_string, frequency_string, min_value_string, max_value_string, \
    start_time_string, is_integer_string, delay_string
...
class TimeseriesMetadataField(Field):
    ...
    def __init__(self):
        ...
        self.frequency = EnumField(frequency_string, frequencies)  # not to check if instant. Check for daily, etc. more than/ less than daily -> gaps
