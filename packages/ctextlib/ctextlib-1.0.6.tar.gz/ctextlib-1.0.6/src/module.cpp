...
PYBIND11_MODULE(ctextlib, m)
{
    py::class_<CTextA> (m, "CTextA")
        ...
        .def("contain", [](CTextA& s, const vector<string>& list, bool bCase)->bool { return s.containAny(list, bCase); }, "returns true if contains any of the provided strings", py::arg("list"), py::arg("case") = true)
        ...
        .def("containOnly", (bool (CTextA::*)(const char* s, bool bCase, bool longList) const) &CTextA::containOnly, "returns true if our string contains only characters in the list", py::arg("str"), py::arg("case") = true, py::arg("longList") = false)
        ...
        .def("endsWithAny", [](CTextA& s, const vector<string>& list, bool bCase)->bool { return s.endsWithAny(list, 0, bCase); }, "returns true if ends with any of the provided strings", py::arg("list"), py::arg("case") = true)
        ...
        .def("fromHex", &CTextA::fromHex<char>, "create a hexadecimal string from the number", py::arg("i"), py::arg("hasBase") = false, py::arg("append") = false)
        .def("fromHex", &CTextA::fromHex<int>, "create a hexadecimal string from the number", py::arg("i"), py::arg("hasBase") = false, py::arg("append") = false)
        .def("fromHex", &CTextA::fromHex<long long>, "create a hexadecimal string from the number", py::arg("i"), py::arg("hasBase") = false, py::arg("append") = false)
        .def("fromInteger", &CTextA::fromInteger<char>, "convert the decimal nteger to string", py::arg("i"), py::arg("append") = false)
        .def("fromInteger", &CTextA::fromInteger<int>, "convert the decimal nteger to string", py::arg("i"), py::arg("append") = false)
        .def("fromInteger", &CTextA::fromInteger<long long>, "convert the decimal integer to string", py::arg("i"), py::arg("append") = false)
        ...
        .def("indexOfAny", [](CTextA& s, const vector<string>& list, bool bCase, bool longList)->size_t { return s.indexOfAny(list, 0, bCase, longList); }, "find the offset of the first instance of the strings in the list", py::arg("list"), py::arg("case") = true, py::arg("longList") = false)
        ...
        .def("nextLine", [](CTextA& s, int pos, CTextT<char>& line, bool appendSeparators, const char* sep)->int { size_t _pos = pos;  bool res = s.nextLine(_pos, line, appendSeparators, sep); return res ? (int)_pos : -1; }, py::arg("pos"), py::arg("line"), py::arg("appendSeparators") = false, py::arg("sep") = CTextA::SeparatorsLine)
        .def("nextWord", [](CTextA& s, int pos, CTextT<char>& line, const char* sep)->int { size_t _pos = pos;  bool res = s.nextWord(_pos, line, sep); return res ? (int)_pos : -1; }, py::arg("pos"), py::arg("line"), py::arg("sep") = CTextA::SeparatorsWord)         
        ...
        .def("removeAny", &CTextA::removeAny<vector<string>>, "remove any from the provided in the list strings", py::arg("list"), py::arg("case") = true, py::arg("longList") = false)
        ...
        .def("replace", [](CTextA& s, const vector<string>& what, const char* c, bool bCase, bool longList)->CTextA& { return s.replaceAny(what, *c, bCase, longList); }, "replace all found strings in list 'what' with a single character ", py::arg("what"), py::arg("with"), py::arg("case") = true, py::arg("longList") = false)
        .def("replaceAny", [](CTextA& s, const vector<string>& what, const vector<string>& with, bool bCase, bool longList)->CTextA& { return s.replaceAny(what, with, bCase, longList); }, "replace found strings in list 'what' with corresponding strings from list 'with' ", py::arg("what"), py::arg("with"), py::arg("case") = true, py::arg("longList") = false)
        .def("replaceAny", [](CTextA& s, const vector<string>& what, const char* with, bool bCase, bool longList)->CTextA& { return s.replaceAny(what, with, bCase, longList); }, "replace found strings in list 'what' with the string 'with' ", py::arg("what"), py::arg("with"), py::arg("case") = true, py::arg("longList") = false)
        ...
        .def("str", (const char* (CTextA::*)(size_t pos) const) &CTextA::str, "trim string from left", py::arg("pos") = 0)
        ...
        .def("wordsReplaceAny", [](CTextA& s, const vector<string>& what, const char* with, bool bCase, const char* sep)->CTextA& { return s.wordsReplaceAny(what, with, bCase, sep); }, "replace found strings from the list with the string 'with' ", py::arg("what"), py::arg("with"), py::arg("case") = true, py::arg("sep") = CTextA::SeparatorsWord)
        .def("wordsReplaceWithChar", [](CTextA& s, const vector<string>& what, const char* c, bool bCase, const char* sep)->CTextA& { return s.wordsReplaceWithChar(what, *c, bCase, sep); }, "replace all found words from the list 'what' with a single character ", py::arg("what"), py::arg("with"), py::arg("case") = true, py::arg("sep") = CTextA::SeparatorsWord)
