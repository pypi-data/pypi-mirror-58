...
PYBIND11_MODULE(ctextlib, m)
{
    py::class_<CTextA> (m, "CTextA")
        ...
        .def("indexOfAny", [](CTextA& s, const vector<string>& list, bool bCase)->size_t { return s.indexOfAny(list, 0, bCase); }, "find the offset of the first instance of the strings in the list", py::arg("list"), py::arg("case") = true)      
        ...
        .def("reduceChain", (CTextA& (CTextA::*)(const char*, char)) &CTextA::reduceChain, "reduce blocks of all separators from the list", py::arg("cList") = CTextA::SeparatorsWord, py::arg("cNew") = *CTextA::SPACE) 
        ...
        .def("removeAny", &CTextA::removeAny<vector<string>>, "remove any from the provided in the list strings", py::arg("list") , py::arg("case") = true)
        ...
        .def("replace", (size_t (CTextA::*)(const char* what, const char* with, bool bCase)) &CTextA::replace, "replace all occurrences of substring \"what\" with substring \"with\"", py::arg("what"), py::arg("with"), py::arg("case") = false)    
        .def("replace", [](CTextA& s, const char* str, size_t len, const char* c)->CTextA& { return s.replace(*str, len, *c); }, "replace range with sizngle character", py::arg("str"), py::arg("len"), py::arg("c"))  
        .def("replace", [](CTextA& s, const vector<string>& what, const char* c, bool bCase)->CTextA& { return s.replaceAny(what, *c, bCase); }, "replace found strings in list 'what' with corresponding strings in list 'with' ", py::arg("what"), py::arg("with"), py::arg("case") = false)
        .def("replaceAny", [](CTextA& s, const vector<string>& what, const vector<string>& with, bool bCase)->CTextA& { return s.replaceAny(what, with, bCase); }, "replace found strings in list 'what' with corresponding strings from list 'with' ", py::arg("what"), py::arg("with"), py::arg("case") = false)
        .def("replaceAny", [](CTextA& s, const vector<string>& what, const char* with, bool bCase)->CTextA& { return s.replaceAny(what, with, bCase); }, "replace found strings in list 'what' with string 'with' ", py::arg("what"), py::arg("with"), py::arg("case") = false)         
