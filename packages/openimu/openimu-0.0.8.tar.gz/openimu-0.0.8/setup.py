...
setup(
    ...
    data_files=[('', ['openimu/app_config/IMU/openimu.json','openimu/app_config/INS/openimu.json','openimu/app_config/VG_AHRS/openimu.json','openimu/app_config/Leveler/openimu.json','openimu/app_config/Compass/openimu.json',])],
