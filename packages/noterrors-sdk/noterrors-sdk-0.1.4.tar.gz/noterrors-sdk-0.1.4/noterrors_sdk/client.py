...
class NotErrorsClient:
    ...
    def init(cls, project_token, auth_key, type='basic', host=None):
        self = NotErrorsClient(project_token, auth_key, type, host)
        if not NotErrorsClient.instance:
            NotErrorsClient.instance = self
            sys.excepthook = NotErrorsClient.excepthook
