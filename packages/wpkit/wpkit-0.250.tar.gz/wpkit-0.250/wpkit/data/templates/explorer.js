            ...
            var vm = new Vue({
                ...
                created: function () {
                    ...
                    if (!this.pan && !this.restoreData()) {
                        this.input({msg:"Input A url that I can host,default:http://127.0.0.1:8002/fs", callback:(url) => {
                            if (!url || url === '') {
                            ...
                            this.openPath(pan);
                        }, defaultValue:"http://127.0.0.1:8002/fs",placeHolder: this.defaultValue});
                    }
                },
                methods: {
