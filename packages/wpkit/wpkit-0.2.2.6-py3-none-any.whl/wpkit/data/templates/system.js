...
sysjs = function () {
    ...
    var openFile = function (pan, location, filename) {
        ...
        if (parts.length > 1) {
            ...
            if (Object.keys(openerMap).indexOf(ext) > -1) {
                ...
                opener.display();
                // dispatchEvent(new QEvent("displayApp", {app: opener}));
                // console.log(opener)
            }
        }
    };
    ...
    class QTaskbarItem extends QWedget {
        ...
        setData() {
            var app = this.app;
            this.title = app.title || app.window.title;
    ...
    class QDisplayEnvironment extends QApplication {
        ...
        lightenApp(app) {
            ...
            // console.log(app.window.el()[0].style.zIndex);
        }

        displayApp(app, callback) {
            var [x, y] = this.getAvailablePosition();
        ...
        getAvailablePosition() {
            if (!this.tasks.length) return [50, 100];
