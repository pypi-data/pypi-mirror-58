explorerjs = function () {
    ...
    var pan = new panjs.Pan("http://127.0.0.1:8000/fs");
    ...
    class Explorer extends QDesktopApplication{
        constructor() {
            super();
            this.window.title="Explorer";
            this.onDisplay.push(()=>{this.init();});
        }
        init() {
            ...
            var vm = new Vue({
                ...
                methods: {
                    ...
                    input: function (msg, callback) {
                        this.window.inputText(msg, (text) => {
                            callback(text);
                        },'text')
                    },
                    ...
                    tryUpload: function (e) {
                        ...
                        this.window.inputFile("Choose file to upload", (name, files) => {
                            ...
                            pan.uploadFile(self.location, file.name, file, (res) => {
                                if (res.success) {
                                    self.info(res.msg);
                                } else {
                                    self.warn(res.msg);
                    ...
                    updateView: function (e) {
                        ...
                        switch (type) {
                            case T.DIR:
                                ...
                                break;
                            case T.FILE:
                                openFile(pan, this.location, name);
                                break;
                            default:
                                null;
                                break;
