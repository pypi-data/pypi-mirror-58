...
class DemoApp(Application):
    def __init__(self,*args,**kwargs):
        ...
        bp=MyBlueprint(url_prefix="/files",name="files",static_map={"files":"/var/www/html"})
        self.register_blueprint(bp)
        # self.register_blueprint(BlueStatic(url_prefix="/files",static_dir="/var/www/html",name="files"))
        if is_linux():
