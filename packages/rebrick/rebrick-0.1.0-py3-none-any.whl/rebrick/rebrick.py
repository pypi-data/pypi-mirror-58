...
class Rebrick(object):
    ...
    def get_parts(self, search=None, part_id=None, part_cat_id=None, color_id=None, bricklink_id=None, brickowl_id=None, lego_id=None, ldraw_id=None):
        """
    ...
    def get_part_category(self, category_id):
        """
        ...
        # send request
        try:
            response = lego.get_part_category(
    ...
    def get_part_categories(self):
        ...
        while True:
            ...
            # send request
            try:
                response = lego.get_part_categories(
                    page = page,
                    api_key = self._api_key)
    ...
    def get_moc_elements(self, moc_id):
        """
    ...
    def get_partlist(self, list_id):
        """
        Gets details about specific parts list.
        ...
        # create partlist
        return Collection.create(data, "partlist")
    
    
    def get_partlists(self):
        """
        Gets a list of all part lists.
        ...
        while True:
            ...
            # create collections
            for item in data['results']:
                partlists.append(Collection.create(item, "partlist"))
    ...
    def get_partlist_elements(self, list_id):
        """
        Gets list of elements for specific parts list.
