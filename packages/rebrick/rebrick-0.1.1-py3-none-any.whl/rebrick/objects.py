...
class Collection(_Entity):
    """
    Represents a Rebrickable set or partlist.
    
    Attributes:
        
        type: str
            Collection type as 'set', 'moc' or 'partlist'.
    ...
    def create(data, set_type="set"):
        ...
        Args:
            ...
            set_type: str
                Type of a collection to create: 'set', 'moc' or 'partlist'.
        ...
        # create user partlist
        if set_type == "partlist":
            return Collection(
                type = 'partlist',
