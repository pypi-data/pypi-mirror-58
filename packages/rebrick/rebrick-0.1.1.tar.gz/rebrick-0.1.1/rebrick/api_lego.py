...
def get_parts(search=None, part_id=None, part_cat_id=None, color_id=None, bricklink_id=None, brickowl_id=None, lego_id=None, ldraw_id=None, page=None, page_size=None, ordering=None, api_key=None):
    """
...
def get_part_category(category_id, api_key=None):
    """
...
def get_part_categories(page=None, page_size=None, ordering=None, api_key=None):
    """
...
def get_moc_elements(moc_id, page=None, page_size=None, ordering=None, api_key=None):
...
def get_set_elements(set_id, page=None, page_size=None, ordering=None, api_key=None):
    """
