...
class CertificateUsageResource(object):
    ...
    swagger_types = {
        'id': 'str',
        'project_usages': 'list[ProjectResource]',
        'library_variable_set_usages': 'list[LibraryVariableSetResource]',
        'tenant_usages': 'list[TenantResource]',
        'deployment_target_usages': 'list[DeploymentTargetResource]',
    ...
    attribute_map = {
        ...
        'library_variable_set_usages': 'LibraryVariableSetUsages',
        'tenant_usages': 'TenantUsages',
        'deployment_target_usages': 'DeploymentTargetUsages',
        'last_modified_on': 'LastModifiedOn',
        'last_modified_by': 'LastModifiedBy',
        'links': 'Links'
    }

    def __init__(self, id=None, project_usages=None, library_variable_set_usages=None, tenant_usages=None, deployment_target_usages=None, last_modified_on=None, last_modified_by=None, links=None):  # noqa: E501
        """CertificateUsageResource - a model defined in Swagger"""  # noqa: E501
    ...
    @library_variable_set_usages.setter
    ...
    @deployment_target_usages.setter
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CertificateUsageResource, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CertificateUsageResource):
            return False
