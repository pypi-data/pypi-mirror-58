...
enum hip_api_id_t {
  ...
  HIP_API_ID_hipEventElapsedTime = 75,
  ...
  HIP_API_ID_hipDevicePrimaryCtxRelease = 154,
  HIP_API_ID_hipHostGetDevicePointer = 155,
  HIP_API_ID_hipMemcpyParam2D = 156,
  HIP_API_ID_hipModuleGetFunction = 157,
  HIP_API_ID_hipMemsetD32Async = 158,
  HIP_API_ID_hipGetDevice = 159,
  HIP_API_ID_hipGetDeviceCount = 160,
  HIP_API_ID_NUMBER = 161,
