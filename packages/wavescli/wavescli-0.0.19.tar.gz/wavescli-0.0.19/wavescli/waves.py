...
class WavesLogger(object):
    ...
    def info(self, message):
        identifier = _task.identifier if _task else 'no-identifier'
        _logger.info(message, extra={'identifier': identifier})


def get_logger(name):
    _logger = get_task_logger('waves.{}'.format(name))
    return WavesLogger(_logger)
