...
class DescribeDirectoryConfigsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeDirectoryConfigs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/appstream.html#AppStream.Paginator.DescribeDirectoryConfigs.paginate)
        """
...
class DescribeFleetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeFleets.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/appstream.html#AppStream.Paginator.DescribeFleets.paginate)
        """
...
class DescribeImageBuildersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeImageBuilders.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/appstream.html#AppStream.Paginator.DescribeImageBuilders.paginate)
        """
...
class DescribeImagesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeImages.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/appstream.html#AppStream.Paginator.DescribeImages.paginate)
        """
...
class DescribeSessionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeSessions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/appstream.html#AppStream.Paginator.DescribeSessions.paginate)
        """
...
class DescribeStacksPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeStacks.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/appstream.html#AppStream.Paginator.DescribeStacks.paginate)
        """
...
class DescribeUserStackAssociationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeUserStackAssociations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/appstream.html#AppStream.Paginator.DescribeUserStackAssociations.paginate)
        """
...
class DescribeUsersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeUsers.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/appstream.html#AppStream.Paginator.DescribeUsers.paginate)
        """
...
class ListAssociatedFleetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListAssociatedFleets.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/appstream.html#AppStream.Paginator.ListAssociatedFleets.paginate)
        """
...
class ListAssociatedStacksPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListAssociatedStacks.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/appstream.html#AppStream.Paginator.ListAssociatedStacks.paginate)
        """
