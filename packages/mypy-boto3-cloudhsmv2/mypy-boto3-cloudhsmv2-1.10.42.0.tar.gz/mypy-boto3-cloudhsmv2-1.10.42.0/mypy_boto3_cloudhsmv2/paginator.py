...
class DescribeBackupsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeBackups.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.42/reference/services/cloudhsmv2.html#CloudHSMV2.Paginator.DescribeBackups.paginate)
        """
...
class DescribeClustersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeClusters.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.42/reference/services/cloudhsmv2.html#CloudHSMV2.Paginator.DescribeClusters.paginate)
        """
...
class ListTagsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListTags.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.42/reference/services/cloudhsmv2.html#CloudHSMV2.Paginator.ListTags.paginate)
        """
