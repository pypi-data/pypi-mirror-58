...
def check_model_compatibility(model_keras, input_is_sparse):
    ...
    ------------------------------------------------
    How to build a compatible Keras quantized model?
    ------------------------------------------------
    ...
    1. General information about layers
    -----------------------------------
    ...
    - Activation layers:
        ...
        - any increasing activation function (only for the last block of
            layers) such as softmax, sigmoid. This layer must derive from
    ...
    3. Constraints about layers' parameters
    ---------------------------------------
    ...
    4. Constraints about the order of layers
    ----------------------------------------
