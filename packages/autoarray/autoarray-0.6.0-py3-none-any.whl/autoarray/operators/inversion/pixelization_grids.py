...
class RectangularGrid(grids.Grid):
    ...
    def __new__(
            cls, grid, shape_2d, pixel_scales, origin=(0.0, 0.0), *args,
            **kwargs
    ):
        ...
        *pixelizations* module.
        ...
        obj = super(RectangularGrid, cls).__new__(cls=cls, grid=grid, mask=mask)
    ...
    def from_shape_2d_and_grid(cls, shape_2d, grid, buffer=1e-8):
        ...
        return RectangularGrid(grid=grid_1d, shape_2d=shape_2d, pixel_scales=pixel_scales, origin=origin)
