class Module(object):
    ...
    async def enable(self):
        ...
        self._enabled = True
        await self.module_manager._call_event('fn:on_enabled', self)
    ...
    async def disable(self):
        ...
        self._enabled = False
        await self.module_manager._call_event('fn:on_disabled', self)
    ...
    def on_event(self, event, func, priority=0, ignore_canceled=False):
        ...
        """
        event = self.module_manager.on_event(self, event, func, priority=priority, ignore_canceled=ignore_canceled)
