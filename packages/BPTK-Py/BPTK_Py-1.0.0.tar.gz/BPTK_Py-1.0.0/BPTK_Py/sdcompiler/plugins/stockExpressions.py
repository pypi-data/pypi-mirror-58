...
def DimJoinedExpression(names, operator,dim):
    ...
    if len(names) == 1:
        return {"name": names[0]+"[{}]".format(dim), "type": 'identifier'}
        ...
        return {
            ...
            "type": 'operator',
            "args": [
                {"name": names[0]+"[{}]".format(dim), "type": 'identifier'},
                {"name": names[1]+"[{}]".format(dim), "type": 'identifier'}
            ]
        }
        ...
        already_reduced = initial = {
            ...
            "type": 'operator',
            "args": [
                {"name": tail[0]+"[{}]".format(dim), "type": 'identifier'},
                {"name": tail[1]+"[{}]".format(dim), "type": 'identifier'}
            ]
        }
        ...
        def reduce(already_reduced, name):
            return {
                "name": operator,
                "type": 'operator',
                "args": [{"name": name+"[{}]".format(dim), "type": 'identifier'}, already_reduced]
            }
