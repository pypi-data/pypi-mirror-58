...
def arrayed_identifiers(expression, dimension):
    ...
    if expression["type"] == "identifier":
        expression["name"] = expression["name"] + "[{}]".format(dimension)
...
def clone_entity(model_name, entity, idx, product=None, connects=None):
    ...
    if product:
        ...
        inflows = DimJoinedExpression(ent["inflow"], "+", dim=product)
        outflows = DimJoinedExpression(ent["outflow"], "+", dim=product)
        ...
        arrayed_identifiers(ent["equation_parsed"], dimension=product)
        ...
        ent["equation_parsed"] = {"name": 'IF', "type": 'call', "args": [
            ...
            {"name": '+', "type": 'operator', "args": [
                {"name": 'PREVIOUS', "type": 'call', "args": [
                    {"name": entity["name"] + "[{}]".format(product), "type": 'identifier'}
                ]},
                {"name": '*', "type": 'operator', "args": [
