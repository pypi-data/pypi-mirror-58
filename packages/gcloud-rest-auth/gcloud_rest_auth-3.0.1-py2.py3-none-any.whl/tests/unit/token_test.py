...
import gcloud.rest.auth.token as token
import pytest
...
def test_service_as_io():
    ...
    service_data = {
        ...
        'client_email': 'gcloud-rest-test@random-project-123.iam.gserviceaccount.com',
        'client_id': '2384283429349234293',
        'auth_uri': 'https://accounts.google.com/o/oauth2/auth',
        'token_uri': 'https://oauth2.googleapis.com/token',
        'auth_provider_x509_cert_url': 'https://www.googleapis.com/oauth2/v1/certs',
        'client_x509_cert_url': 'https://www.googleapis.com/robot/v1/metadata/x509/gcloud-rest%40random-project-123.iam.gserviceaccount.com'
    }
    ...
    assert t.get_project() == 'random-project-123'
