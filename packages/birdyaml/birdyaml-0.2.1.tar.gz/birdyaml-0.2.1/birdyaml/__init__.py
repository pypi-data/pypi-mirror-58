...
class YamlObject:
    ...
    def to_obj_(self, loader=_DEFAULT_LOADER) -> Any:
...
def load_file(filename, loader=_DEFAULT_LOADER) -> Any:
    with open(filename) as f:
        return load(f, loader=loader)


def load(fp, loader=_DEFAULT_LOADER) -> Any:
    return _load(yaml.load(fp, Loader=loader))


def loads(s, loader=_DEFAULT_LOADER) -> Any:
    return _load(yaml.load(s, Loader=loader))


def load_obj(obj) -> Any:
    return _load(obj)
