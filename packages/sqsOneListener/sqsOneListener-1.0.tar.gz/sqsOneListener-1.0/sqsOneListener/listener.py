# ================
# This code is from Yaakov Gesher
# I needed a few modifications to suit my use case
# ================
...
class SQSListener:
    ...
    def __init__(self, queue, **kwargs):
        ...
        self._poll_interval = kwargs.get("interval", 10)
        self._queue_visibility_timeout = kwargs.get('visibility_timeout', '60')  # in seconds
        self._error_queue_name = kwargs.get('error_queue', None)
        self._error_queue_visibility_timeout = kwargs.get('error_visibility_timeout', '0')
        ...
        while not read:
            ...
            if 'Messages' in messages:
                ...
                for m in messages['Messages']:
                    sqs_logger.info("Message content {} ".format(m['Body']))
