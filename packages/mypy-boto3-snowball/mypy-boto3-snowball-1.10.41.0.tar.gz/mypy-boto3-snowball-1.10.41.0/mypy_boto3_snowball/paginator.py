...
class DescribeAddressesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeAddresses.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/snowball.html#Snowball.Paginator.DescribeAddresses.paginate)
        """
...
class ListClusterJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListClusterJobs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/snowball.html#Snowball.Paginator.ListClusterJobs.paginate)
        """
...
class ListClustersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListClusters.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/snowball.html#Snowball.Paginator.ListClusters.paginate)
        """
...
class ListCompatibleImagesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListCompatibleImages.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/snowball.html#Snowball.Paginator.ListCompatibleImages.paginate)
        """
...
class ListJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListJobs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/snowball.html#Snowball.Paginator.ListJobs.paginate)
        """
