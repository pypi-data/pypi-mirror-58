...
#                         variable_linkage=None)
#
#     result = mainPart(X, y, pset, pop_n=500, random_seed=1, cxpb=0.5, mutpb=0.5, ngen=20, tournsize=3, max_value=10,
#                       max_=4,
...
#     x4 = sympy.Symbol("x4")
#
#     expr01 = ((x0 ** 0.5 * x1 ** (-0.5)) ** 0.5 * sympy.log(x2 / x3) ** 2) ** 0.5
#     terminals = [x0, x1, x2, x3, x4]
#     score, expr01 = calculateExpr(expr01, X, y, terminals, scoring=None, add_coeff=True,
#                                   del_no_important=False, filter_warning=True, inter_add=True, iner_add=True,
#                                   random_add=None)
#
# #5
# if __name__ == '__main__':
