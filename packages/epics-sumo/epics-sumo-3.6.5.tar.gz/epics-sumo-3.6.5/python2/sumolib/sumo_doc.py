...
'_order': ['config list', 'config show [OPTIONNAMES]', 'config make FILENAME [OPTIONNAMES]', 'config new DIRECTORY TEMPLATE', 'config standalone DIRECTORY', 'config local DIRECTORY'],
"": r"""
subcommands for maincommand "config"
++++++++++++++++++++++++++++++++++++
""",
