...
class Session(object):
	...
	def __init__(self, domain=None, username=None, api_key=None, pwd=None, hostname=None, port=None, proxy=None, verbose=False, dev=False):
		...
		if domain is None:
			if not ('ACCSYN_DOMAIN' in os.environ or 'ACCSYN_ORG' in os.environ or 'FILMUB_DOMAIN' in os.environ or 'FILMHUB_ORG' in os.environ):
	...
	def find(self, query, attributes=None, finished=None, limit=None, skip=None):
