...
def xor(k1, k2):
    ...
    # xor_count = format(int(k1, 2) ^ int(k2, 2), 'b').count('1')
    # print(k1, k2, len(k1), len(k2), xor_count)
    # print(xor_count)
    # return xor_count
...
async def hit(fingerprint, title, num_drawer, max_distance, path_config=None):
