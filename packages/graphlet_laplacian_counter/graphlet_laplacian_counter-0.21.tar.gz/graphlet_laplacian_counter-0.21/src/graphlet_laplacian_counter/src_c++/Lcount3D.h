...
//
//static const int orbitOvercount[73] = {1,4,4,12,6,6,18,18,24,12,12,12,36,36,72,2,2,2,2,2,2,2,24,24,2,2,2,4,4,4,4,4,4,4,10,4,4,4,4,
//                                       4,4,4,4,8,8,8,8,8,8,12,12,14,14,14,12,12,12,12,12,20,20,20,28,28,28,36,36,36,48,48,72,72,120};
...
public:
    ...
    virtual void  getOverCountCorrectedRowOverOrbits(std::vector<unsigned int> orbits ,int row,std::vector<int64>& correctedRow)=0;
