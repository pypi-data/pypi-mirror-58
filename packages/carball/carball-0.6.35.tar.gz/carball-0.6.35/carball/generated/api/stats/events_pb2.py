...
_HIT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='DEPRECATED_field_goal_number', full_name='api.stats.Hit.DEPRECATED_field_goal_number', index=23,
...
_FIFTYFIFTY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='winning_team', full_name='api.stats.FiftyFifty.winning_team', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='losing_team', full_name='api.stats.FiftyFifty.losing_team', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_neutral', full_name='api.stats.FiftyFifty.is_neutral', index=6,
      number=7, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FIFTYFIFTY.fields_by_name['hits'].message_type = _HIT
_FIFTYFIFTY.fields_by_name['players'].message_type = player_id_pb2._PLAYERID
_FIFTYFIFTY.fields_by_name['winning_team'].message_type = team_pb2._TEAM
_FIFTYFIFTY.fields_by_name['losing_team'].message_type = team_pb2._TEAM
