...
def get_model(name: str):
    ...
    if m in LOADED_MODEL:
        ...
        model = pretrained('GalAster/StyleGAN-Zoo', 'style_asashio', pretrained=True)
        LOADED_MODEL[m] = model
        return model
    elif m == 'animehead':
        ...
        model = pretrained('GalAster/StyleGAN-Zoo', 'style_vessel', pretrained=True)
        LOADED_MODEL[m] = model
        return model
    elif m == 'qinghua':
        model = pretrained('GalAster/StyleGAN-Zoo', 'style_qinghua', pretrained=True)
        LOADED_MODEL[m] = model
        return model
    else:
