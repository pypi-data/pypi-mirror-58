...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        impname, imppathname = get_modulelocation(
            'subpackage3.submodule1', mypath, ('testpackage',))
        
        self.assertEqual(impname, "testpackage.subpackage3.submodule1")
        self.assertTrue(imppathname.endswith(
            os.path.join("testpackage","subpackage3","submodule1.py")))
