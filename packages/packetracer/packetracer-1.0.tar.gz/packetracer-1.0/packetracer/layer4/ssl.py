...
from packetracer.structcbs import unpack_H, unpack_I
...
class Extension(packetracer.Packet):
	"""
...
# Record contents
#
class Handshake(packetracer.Packet):
	...
	len_i = packetracer.get_property_bytes_num("len", ">I")
...
class HandshakeHello(packetracer.Packet):
...
class HandshakeData(packetracer.Packet):
	pass


class ChangeCipherSpec(packetracer.Packet):
	pass


class ApplicationData(packetracer.Packet):
	pass


class Record(packetracer.Packet):
	"""
