...
# handler
from packetracer.layer12 import ieee80211
from packetracer.structcbs import pack_H_le, unpack_H_le, unpack_I
...
class Radiotap(packetracer.Packet):
	__hdr__ = (
		("version", "B", 0),
		("pad", "B", 0),
		("len", "H", 0x0800),
	...
	def bin(self, update_auto_fields=True):
		...
		return packetracer.Packet.bin(self, update_auto_fields=update_auto_fields) + self.fcs
