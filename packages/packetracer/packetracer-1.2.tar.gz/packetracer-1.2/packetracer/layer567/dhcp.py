...
from packetracer.layer12 import arp
...
class DHCP(packetracer.Packet):
    ...
    ciaddr_s = packetracer.get_property_ip4("ciaddr")
    yiaddr_s = packetracer.get_property_ip4("yiaddr")
    siaddr_s = packetracer.get_property_ip4("siaddr")
    giaddr_s = packetracer.get_property_ip4("giaddr")
...
class DHCPOpt(packetracer.Packet):
    __hdr__ = (
        ("type", "B", 0),
        ("len", "B", 0),
    )
...
class Padding(packetracer.Packet):
    pass
