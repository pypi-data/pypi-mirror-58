...
class BGP(packetracer.Packet):
    ...
    class Open(packetracer.Packet):
        ...
        class Parameter(packetracer.Packet):
            __hdr__ = (
                ("type", "B", 0),
                ("len", "B", 0)
            )

    class Update(packetracer.Packet):
        __hdr__ = (
            ("withdrawnlen", "H", 0),
            ("pathlen", "H", 0),
        ...
        class Attribute(packetracer.Packet):
            __hdr__ = (
                ("flags", "B", 0),
                ("type", "B", 0),
                ("len", "B", 0)
            ...
            class Origin(packetracer.Packet):
                __hdr__ = (
                    ("type", "B", ORIGIN_IGP),
                )

            class ASPath(packetracer.Packet):
                __hdr__ = (
                ...
                class ASPathSegment(packetracer.Packet):
                    __hdr__ = (
                        ("type", "B", 0),
                        ("len", "B", 0)
                    )

            class NextHop(packetracer.Packet):
                __hdr__ = (
                    ("ip", "I", 0),
                )

            class MultiExitDisc(packetracer.Packet):
                __hdr__ = (
                    ("value", "I", 0),
                )

            class LocalPref(packetracer.Packet):
                __hdr__ = (
                    ("value", "I", 0),
                )

            class AtomicAggregate(packetracer.Packet):
                pass

            class Aggregator(packetracer.Packet):
                __hdr__ = (
                    ("asn", "H", 0),
                    ("ip", "I", 0)
                )

            class OriginatorID(packetracer.Packet):
                __hdr__ = (
                    ("value", "I", 0),
                )

            class ClusterList(packetracer.Packet):
                pass

            class MPReachNLRI(packetracer.Packet):
                __hdr__ = (
                    ("afi", "H", AFI_IPV4),
                    ("safi", "B", SAFI_UNICAST),
                )

            class MPUnreachNLRI(packetracer.Packet):
                __hdr__ = (
                    ("afi", "H", AFI_IPV4),
                    ("safi", "B", SAFI_UNICAST),
                )

            class Communitie(packetracer.Packet):
                pass
    ...
    class Notification(packetracer.Packet):
        __hdr__ = (
            ("code", "B", 0),
            ("subcode", "B", 0),
        )

    class Keepalive(packetracer.Packet):
        pass

    class RouteRefresh(packetracer.Packet):
        __hdr__ = (
            ("afi", "H", AFI_IPV4),
            ("rsvd", "B", 0),
            ("safi", "B", SAFI_UNICAST)
...
class Route(packetracer.Packet):
    __hdr__ = (
        ("len", "B", 0),
    )
