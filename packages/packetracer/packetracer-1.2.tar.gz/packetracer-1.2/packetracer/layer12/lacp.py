...
from packetracer.structcbs import unpack_BB
...
class LACPActorInfoTlv(packetracer.Packet):
    __hdr__ = (
        ("type", "B", ACTOR_TYPE),
    ...
    sys_s = packetracer.get_property_mac("sys")
...
class LACPPartnerInfoTlv(packetracer.Packet):
    __hdr__ = (
        ("type", "B", PARTNER_TYPE),
...
class LACPCollectorInfoTlv(packetracer.Packet):
    __hdr__ = (
...
class LACPTerminatorTlv(packetracer.Packet):
    __hdr__ = (
...
class LACPReserved(packetracer.Packet):
    __hdr__ = (
