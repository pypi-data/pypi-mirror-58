...
from packetracer.structcbs import unpack_H, pack_Q, unpack_Q_le
...
class IEEE80211(packetracer.Packet):
    __hdr__ = (
        # AAAABBCC | 00000000
    ...
    def _dissect(self, buf):
        ...
        #	packetracer.Packet._id_handlerclass_dct[self.__class__][TYPE_FACTORS[self.type] + self.subtype]))
    ...
    # mgmt frames
    #
    class Beacon(packetracer.Packet):
        __hdr__ = (
            ("dst", "6s", b"\x00" * 6),
            ("src", "6s", b"\x00" * 6),
            ("bssid", "6s", b"\x00" * 6),
        ...
        dst_s = packetracer.get_property_mac("dst")
        bssid_s = packetracer.get_property_mac("bssid")
        src_s = packetracer.get_property_mac("src")
    ...
    class Action(packetracer.Packet):
        __hdr__ = (
            ("dst", "6s", b"\x00" * 6),
            ("src", "6s", b"\x00" * 6),
            ("bssid", "6s", b"\x00" * 6),
        ...
        class BlockAckRequest(packetracer.Packet):
            __hdr__ = (
                ("dialog", "B", 0),
                ("parameters", "H", 0),
                ("timeout", "H", 0),
        ...
        class BlockAckResponse(packetracer.Packet):
            __hdr__ = (
                ("dialog", "B", 0),
                ("status_code", "H", 0),
                ("parameters", "H", 0),
    ...
    class ProbeReq(packetracer.Packet):
        __hdr__ = (
            ("dst", "6s", b"\x00" * 6),
            ("src", "6s", b"\x00" * 6),
            ("bssid", "6s", b"\x00" * 6),
    ...
    class AssocReq(packetracer.Packet):
        __hdr__ = (
            ("dst", "6s", b"\x00" * 6),
            ("src", "6s", b"\x00" * 6),
            ("bssid", "6s", b"\x00" * 6),
    ...
    class AssocResp(packetracer.Packet):
        __hdr__ = (
            ("dst", "6s", b"\x00" * 6),
            ("src", "6s", b"\x00" * 6),
            ("bssid", "6s", b"\x00" * 6),
    ...
    class Disassoc(packetracer.Packet):
        __hdr__ = (
            ("dst", "6s", b"\x00" * 6),
            ("src", "6s", b"\x00" * 6),
            ("bssid", "6s", b"\x00" * 6),
    ...
    class ReassocReq(packetracer.Packet):
        __hdr__ = (
            ("dst", "6s", b"\x00" * 6),
            ("src", "6s", b"\x00" * 6),
            ("bssid", "6s", b"\x00" * 6),
    ...
    class Deauth(packetracer.Packet):
        __hdr__ = (
            ("dst", "6s", b"\xff" * 6),
            ("src", "6s", b"\x00" * 6),
            ("bssid", "6s", b"\xff" * 6),
    ...
    class BlockAckReq(packetracer.Packet):
        __hdr__ = (
            ("dst", "6s", b"\x00" * 6),
            ("src", "6s", b"\x00" * 6),
            ("reqctrl", "H", 0),
    ...
    class BlockAck(packetracer.Packet):
        __hdr__ = (
            ("dst", "6s", b"\x00" * 6),
            ("src", "6s", b"\x00" * 6),
            ("reqctrl", "H", 0),
    ...
    class CFEnd(packetracer.Packet):
        __hdr__ = (
            ("dst", "6s", b"\x00" * 6),
            ("src", "6s", b"\x00" * 6),
        )
    ...
    # Data frames
    #
    class Dataframe(packetracer.Packet):
        """
    ...
    class IE(packetracer.Packet):
        __hdr__ = (
            ("id", "B", 0),
            ("len", "B", 0)
        )

    class FH(packetracer.Packet):
        __hdr__ = (
            ("id", "B", 0),
            ("len", "B", 0),
            ("tu", "H", 0),
...
packetracer.Packet.load_handler(IEEE80211, decoder_dict_complete)

# handler for Action
CATEGORY_BLOCK_ACK_FACTOR = IEEE80211.Action.CATEGORY_BLOCK_ACK * 4
packetracer.Packet.load_handler(IEEE80211.Action,
                                {
