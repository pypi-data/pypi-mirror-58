...
from packetracer import checksum
...
class ICMP6(packetracer.Packet):
    __hdr__ = (
        ("type", "B", 0),
        ("code", "B", 0),
        ("sum", "H", 0)
    ...
    class Error(packetracer.Packet):
        __hdr__ = (("pad", "I", 0),)
    ...
    class ICMPv6Opt(packetracer.Packet):
        __hdr__ = (
            ("type", "B", 0),
            ("len", "B", 0)
        )
    ...
    class NeighbourSolicitation(packetracer.Packet):
        __hdr__ = (
            ("rsv", "4s", b"\x00" * 4),
            ("target", "16s", b"\x00" * 16),
    ...
    class NeighbourAdvertisement(packetracer.Packet):
        __hdr__ = (
            ("flags", "4s", b"\x00" * 4),
            ("target", "16s", b"\x00" * 16),
            ("opts", None, triggerlist.TriggerList)
