...
# handler
from packetracer.layer12 import arp, dtp, pppoe, flow_control, lacp
from packetracer.layer12 import lldp, slac
from packetracer.layer3 import ip, ip6, ipx
from packetracer.layer567 import ptpv2
from packetracer.packetracer_meta import FIELD_FLAG_IS_TYPEFIELD
...
class Dot1Q(packetracer.Packet):
    __hdr__ = (
    ...
    type_t = packetracer.get_property_translator("type", "ETH_TYPE_")
...
class Ethernet(packetracer.Packet):
    __hdr__ = [
        ("dst", "6s", b"\xff" * 6),
        ("src", "6s", b"\xff" * 6),
    ...
    def bin(self, update_auto_fields=True):
        ...
        return packetracer.Packet.bin(self, update_auto_fields=update_auto_fields) + self.padding
    ...
    padding = packetracer.get_ondemand_property("padding", lambda: b"")
