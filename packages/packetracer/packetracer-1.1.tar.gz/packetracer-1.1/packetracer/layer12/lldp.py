...
from packetracer.packetracer import (mac_str_to_bytes, mac_bytes_to_str,
...
from packetracer.structcbs import pack_B, unpack_B, unpack_H, unpack_I
...
class LLDPGeneric(packetracer.Packet):
    __hdr__ = (
...
class LLDPDUEnd(packetracer.Packet):
    __hdr__ = (
        ("tlv_type", "B", 0),
        ("tlv_len", "B", 0),
    )
...
class LLDPChassisId(packetracer.Packet):
    __hdr__ = (
...
class LLDPPortId(packetracer.Packet):
    __hdr__ = (
...
class LLDPTTL(packetracer.Packet):
    __hdr__ = (
...
class LLDPPortDescription(packetracer.Packet):
    __hdr__ = (
...
class LLDPSystemName(packetracer.Packet):
    __hdr__ = (
...
class LLDPSystemDescription(packetracer.Packet):
    __hdr__ = (
...
class LLDPSystemCapabilities(packetracer.Packet):
    __hdr__ = (
...
class LLDPManagementAddress(packetracer.Packet):
    __hdr__ = (
...
class LLDPOrgSpecGeneric(packetracer.Packet):
    __hdr__ = (
...
class LLDPDot1PortVlanId(packetracer.Packet):
    __hdr__ = (
...
class DCBXCongestionNotification(packetracer.Packet):
    __hdr__ = (
        ("type_len", "H", 65030),  # type(127), length(6)
...
class DCBXConfiguration(packetracer.Packet):
    __hdr__ = (
...
class DCBXRecommendation(packetracer.Packet):
    __hdr__ = (
        ("type_len", "H", 65049),  # type(127), length(25)
...
class DCBXPriorityBasedFlowControlConfiguration(packetracer.Packet):
    __hdr__ = (
        ("type_len", "H", 65030),  # type(127), length(6)
...
class DCBXApplicationPriority(packetracer.Packet):
    __hdr__ = (
        ("type_len", "H", 65024, FIELD_FLAG_AUTOUPDATE),  # type(127)
...
class DCBXApplicationPriorityTable(packetracer.Packet):
    __hdr__ = (
