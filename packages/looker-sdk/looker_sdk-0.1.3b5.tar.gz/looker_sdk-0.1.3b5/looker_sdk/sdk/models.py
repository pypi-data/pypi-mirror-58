...
class ContentValidationDashboardFilter(model.Model):
    ...
    Attributes:
        ...
        model_name: Model name of filter
        explore: Explore of filter
        dimension: Dimension of filter
    """
...
class Datagroup(model.Model):
    ...
    Attributes:
        ...
        id: ID of the datagroup. Also used as the unique identifier.
...
class Dialect(model.Model):
    ...
    Attributes:
        ...
        supports_upload_tables: Whether the dialect supports uploading tables
    ...
    supports_upload_tables: Optional[bool] = None
...
class Integration(model.Model):
    ...
    Attributes:
        ...
        supported_formats: A list of data formats the integration supports. If unspecified, this will default to ["txt", "csv", "inline_json", "json", "json_label", "json_detail", "json_detail_lite_stream", "xlsx", "html", "wysiwyg_pdf", "assembled_pdf", "wysiwyg_png", "csv_zip"]. Valid values are: "txt", "csv", "inline_json", "json", "json_label", "json_detail", "json_detail_lite_stream", "xlsx", "html", "wysiwyg_pdf", "assembled_pdf", "wysiwyg_png", "csv_zip".
        supported_action_types: A list of action types the integration supports. Valid values are: "cell", "query", "dashboard".
        supported_formattings: A list of formatting options the integration supports. If unspecified, this will default to ["formatted", "unformatted"]. Valid values are: "formatted", "unformatted".
        supported_visualization_formattings: A list of visualization formatting options the integration supports. If unspecified, this will default to ["apply", "noapply"]. Valid values are: "apply", "noapply".
        ...
        installed_delegate_oauth: OAuth info when the admin installed the integration using delegate oauth.
    ...
    installed_delegate_oauth: Optional[str] = None
...
class InternalHelpResources(model.Model):
    """
    Attributes:
        enabled: If true and internal help resources content is not blank then the link for internal help resources will be show in the help menu and the content displayed within Looker
        can: Operations the current user is able to perform on this object
    """
...
class LookmlModelExploreFieldTimeInterval(model.Model):
    """
    Attributes:
        name: The type of time interval this field represents a grouping of. Valid values are: "day", "hour", "minute", "month", "year".
...
@attr.s(auto_attribs=True, kw_only=True, init=False)
class WriteDataActionRequest(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True, init=False)
class WriteEmbedSsoUrlParams(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True, init=False)
class WriteSqlQueryCreate(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True, init=False)
class WriteWriteScheduledPlan(model.Model):
    """
...
cattr.register_structure_hook(
    ForwardRef("WriteDataActionRequest"),  # type: ignore
    structure_hook,  # type:ignore
)
cattr.register_structure_hook(
...
cattr.register_structure_hook(
    ForwardRef("WriteEmbedSsoUrlParams"),  # type: ignore
    structure_hook,  # type:ignore
)
cattr.register_structure_hook(
    ForwardRef("WriteFolder"),  # type: ignore
    structure_hook,  # type:ignore
)
cattr.register_structure_hook(
...
cattr.register_structure_hook(
    ForwardRef("WriteSpace"),  # type: ignore
    structure_hook,  # type:ignore
)
cattr.register_structure_hook(
...
cattr.register_structure_hook(
    ForwardRef("WriteSqlQueryCreate"),  # type: ignore
    structure_hook,  # type:ignore
)
cattr.register_structure_hook(
...
cattr.register_structure_hook(
    ForwardRef("WriteWriteScheduledPlan"),  # type: ignore
    structure_hook,  # type:ignore
)
