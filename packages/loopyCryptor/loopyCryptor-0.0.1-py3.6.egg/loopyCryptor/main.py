...
class loopyCryptor:
    ...
    def RSA_encrypt(cls, byte, public_key=None):
        ...
        :return: byte Encrypted byte stream
        """
        public_key = cls._validate_key(public_key if public_key is not None else cls.__RSA_key[1])
    ...
    def RSA_decrypt(cls, byte, private_key=None):
        ...
        """
        private_key = cls._validate_key(private_key if private_key is not None else cls.__RSA_key[0])
