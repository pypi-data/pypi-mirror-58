...
_ODOMETRY_MAVFRAME = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='MOCAP_NED', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LOCAL_FRD', index=1, number=1,
      serialized_options=None,
      type=None),
  ],
