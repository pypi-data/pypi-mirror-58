...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository_version=None, pulp_href=None, repository=None, base_path=None, content_guard=None, name=None, pulp_created=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
