...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository_version=None, base_path=None, name=None, repository=None, content_guard=None, pulp_href=None, pulp_created=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
