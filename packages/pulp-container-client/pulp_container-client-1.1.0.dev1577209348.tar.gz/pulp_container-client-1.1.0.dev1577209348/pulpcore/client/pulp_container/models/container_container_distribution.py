...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_created=None, pulp_href=None, name=None, repository=None, base_path=None, repository_version=None, content_guard=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
