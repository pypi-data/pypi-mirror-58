...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_created=None, pulp_href=None, name=None, content_guard=None, repository_version=None, base_path=None, repository=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
