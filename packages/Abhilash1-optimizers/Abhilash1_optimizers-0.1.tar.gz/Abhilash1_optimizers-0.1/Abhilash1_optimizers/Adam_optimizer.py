# -*- coding: utf-8 -*-
"""
Created on Fri Dec 27 16:51:45 2019
...
class ADAM():
    ...
    def Adam_optimizer(data,len_data,max_itr,alpha,b_1,b_2,epsilon,noise_g,act_func,scale):
        ...
        m_t,v_t,t,theta_0=ADAM.init(0,0,0,0)
        final_weight_vector=[]
        for i in range(len_data):
            ...
            for i in range(max_itr):
                ...
                v_hat=v_t/(1-(b_2**t))
                theta_prev=theta_0
                theta_0=theta_prev-((alpha*(m_t)/(math.sqrt(v_hat) +  epsilon)))
    ...
    def initialize(data,max_itr):
        len_data=len(data)
        optimized_weights=ADAM.Adam_optimizer(data,len_data,max_itr,alpha,b_1,b_2,epsilon,noise_g,act_func,scale)
...
if __name__=='__main__':
    ...
    ADAM.initialize(sample_data,10)    
