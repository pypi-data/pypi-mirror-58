...
class SGD():
    ...
    def SGD_optimizer(data,len_data,max_itr,alpha,b_1,b_2,epsilon,noise_g,act_func,scale):
        alpha,b_1,b_2,epsilon,noise_g=SGD.__init__(alpha,b_1,b_2,epsilon,noise_g)
        m_t,v_t,t,theta_0=SGD.init(0,0,0,0)
        final_weight_vector=[]
    ...
    def initialize(data,max_itr):
        len_data=len(data)
        optimized_weights=SGD.SGD_optimizer(data,len_data,max_itr,alpha,b_1,b_2,epsilon,noise_g,act_func,scale)
...
if __name__=='__main__':
    ...
    SGD.initialize(sample_data,100)    
