...
setup(
  name = 'Abhilash1_optimizers',         
  packages = ['Abhilash1_optimizers'],   
  version = '0.1',       
  license='MIT',        
  ...
  url = 'https://github.com/abhilash1910/Abhilash1_optimizers_package',   
  download_url = 'https://github.com/abhilash1910/Abhilash1_optimizers_package/archive/v_01.tar.gz',    
