...
class Encoder(tf.keras.layers.Layer):
    ...
    def __init__(self, num_layers, d_model, num_heads, dff, input_vocab_size, activation, rate=0.1):
        """
        ...
        self.enc_layers = [EncoderLayer(d_model, num_heads, dff, activation, rate) for _ in range(num_layers)]
