...
class Decoder(tf.keras.layers.Layer):
    ...
    def __init__(self, num_layers, d_model, num_heads, dff, target_vocab_size, activation, rate=0.1):
        """
        ...
        self.dec_layers = [DecoderLayer(d_model, num_heads, dff, activation, rate) for _ in range(num_layers)]
