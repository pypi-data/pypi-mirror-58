...
class Keeper(object):
    ...
    def __init__(self, contract_names=None):
        ...
        try:
            ...
            logging.error(f'Contract artifact {EscrowAccessSecretStoreTemplate.CONTRACT_NAME} is not found: {err}')
        ...
        try:
            ...
            logging.error(f'Contract artifact {EscrowComputeExecutionTemplate.CONTRACT_NAME} is not found: {err}')
