...
class Base(Controller):
    ...
    def sg(self):
        ...
        if self.app.pargs.action=='show':
            pp(get_sg(self.app.pargs.name, self.app.pargs.profile or self.app.pargs.p))

        elif self.app.pargs.action=='update':
            update_sg_to_ip(sg_name=self.app.pargs.name, ip=self.app.pargs.ip,
                            profile=self.app.pargs.profile or self.app.pargs.p)
    ...
    def fls(self):
        from ..ext.fluidstack import avail_fl_nodes, show_running, \
            stop_containers, start_container
        args = self.app.pargs
    ...
    def ssh(self):
        #TODO: missing servers 
        # TODO: rethink UX of -profile -host
