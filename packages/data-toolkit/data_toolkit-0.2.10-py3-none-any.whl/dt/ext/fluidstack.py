...
def init():
    ...
    from fluidstack_auth import credential_id, credential_secret, password
...
def start_container(container_id: str):
    ...
    with open('/Users/jakub/.ssh/id_rsa') as f:
        ssh_key = f.read()
    data = {"node_id": container_id, "image": "fluidstackio/pytorch",
            "ports": ["22/tcp", "8888/tcp"], "gpus": "all", "ssh_key": ssh_key}
