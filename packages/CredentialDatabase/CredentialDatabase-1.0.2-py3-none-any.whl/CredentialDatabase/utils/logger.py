...
from CredentialDatabase import ROOT_DIR


class Logger:
    """Singleton class Logger to set up a Logger instance
    USAGE:
            Logger(name='CredentialDatabase')
    """
    __instance = None

    def __init__(self, name='CredentialDatabase', level='info', log_folder='/var/log/', log_max_bytes=10000000, backup=5):
    ...
    def __create_log_folder(self, log_folder):
        """creates log folder in '/var/log/CredentialDatabase'
