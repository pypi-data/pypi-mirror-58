...
@File    :   embedding_bert_intent_estimator_classifier.py
...
class EmbeddingBertIntentEstimatorClassifier(Component):
    ...
    def _load_flag_if_tokenize_intents(self):
        ...
        if self.intent_tokenization_flag and not self.intent_split_symbol:
            logger.warning("intent_split_symbol was not specified, "
                           "so classifiers tokenization will be ignored")
    ...
    def _create_intent_token_dict(intents, intent_split_symbol):
        """Create classifiers token dictionary"""
    ...
    def train(self, training_data, cfg=None, **kwargs):
        ...
        if len(intent_dict) < 2:
            logger.error("Can not train an classifiers classifier. "
                         ...
                         "Skipping training of classifiers classifier.")
            return
    ...
    def process(self, message, **kwargs):
        ...
        """Return the most likely classifiers and its similarity to the input."""
