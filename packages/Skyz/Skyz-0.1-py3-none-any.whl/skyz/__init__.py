...
"""
    ...
    A database API scraped from web.py. 
...
from .compat import PY2, iteritems, numeric_types, string_types, text_type
from .helpers import iters, safestr, safeunicode, storage, threadeddict
