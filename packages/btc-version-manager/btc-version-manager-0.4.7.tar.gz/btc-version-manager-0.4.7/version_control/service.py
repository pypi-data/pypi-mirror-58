...
class VersionControlManager:
    ...
    def get_storage(self) -> Type[VersionControlTemporaryStorage]():
        if not self._storage:
            self._storage = self.storage_class(storage_key=self.request_key, timeout=self.storage_timeout)
    ...
    @debug_method
    def init_storage_from_cache(self):
        storage = self.get_storage()
        storage.init_storage_from_cache()
