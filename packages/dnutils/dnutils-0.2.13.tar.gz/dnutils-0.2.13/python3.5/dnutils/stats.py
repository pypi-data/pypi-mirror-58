...
class Gaussian(object):
    ...
    # def pdf(self, X):
    #     '''
    #     Evaluate the Gaussian probability density function (PDF) at the positions ``X``.
    #     :param X:   A ``NxM`` matrix of values, where ``N`` is the number of positions to evaluate, and ``M`` is
