...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.1.0-alpha.1576668801+g0d6294dd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.1.0-alpha.1576668801+g0d6294dd`
                """)
            else:
                raise
