...
class AutoMLConfig(object):
    """
    Represents configuration for submitting an Automated Machine Learning experiment in Azure Machine Learning.
    ...
    :param featurization:
        ...
        https://docs.microsoft.com/azure/machine-learning/service/how-to-create-portal-experiments#advanced-preprocessing-options
    ...
    def __init__(self,
        ...
        :param primary_metric:
            The metric that Automated Machine Learning will optimize for model selection.
            Automated Machine Learning collects more metrics than it can optimize.
            Use the :meth:`azureml.train.automl.utilities.get_primary_metrics` function to get a list of
            valid metrics for your given task. See
            https://docs.microsoft.com/azure/machine-learning/service/how-to-configure-auto-train
            for details on how these metrics are calculated.
        ...
        :param experiment_timeout_hours:
            Maximum amount of time in hours that all iterations combined can take before the
            experiment terminates.
        :type experiment_timeout_minutes: float
        :param experiment_exit_score:
            Target score for experiment. Experiment will terminate after this score is reached.
        :type experiment_exit_score: float
        :param enable_early_stopping:
