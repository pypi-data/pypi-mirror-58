...
__all__ = ["CostFunction",
           ...
           "CostFunction_NegLogLikelihoodRatio",
...
class CostFunction_Chi2(CostFunction):
    def __init__(self, errors_to_use='covariance', fallback_on_singular=True):
        ...
        super(CostFunction_Chi2, self).__init__(cost_function=_chi2_func)
    ...
    @staticmethod
    def chi2_no_errors(data, model, parameter_values, parameter_constraints, nuisance_penalty):
...
class CostFunction_NegLogLikelihood(CostFunction):
    def __init__(self, data_point_distribution='poisson'):
        ...
        super(CostFunction_NegLogLikelihood, self).__init__(cost_function=_nll_func)
...
class CostFunction_NegLogLikelihoodRatio(CostFunction):
    def __init__(self, data_point_distribution='poisson'):
        r"""
        ...
        super(CostFunction_NegLogLikelihoodRatio, self).__init__(cost_function=_nll_func)
...
class CostFunction_Chi2_Nuisance(CostFunction_Chi2):
    ...
    def __init__(self, errors_to_use='covariance', fall_back_on_singular=True):
        ...
        if errors_to_use is None:
            _chi2_nui = self.chi2_no_errors  # inherited from CostFunction_Chi2
