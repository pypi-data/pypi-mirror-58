...
# 二元一次方程
def line_equation_2unknown(a, b, u, c, d, v):
    if [0] not in [a, b, c, d]:
        try:
            return (d*u-b*v)/(a*d-b*c), (a*v-u*c)/(a*d-b*c)
        except ZeroDivisionError:
            return None
    else:
        return "not a 2unknown equation"
...
if __name__ == '__main__':
    print(line_equation_2unknown(4, 5, 85858, 3, 25, 0))
