...
class HistoricalPricing(object):
    """
    """
    _URL_HISTORICALPRICING = 'data/historical-pricing/v1'
    ...
    async def _get_events_async(self,
        ...
        _url = '/'.join([HistoricalPricing._URL_HISTORICALPRICING, 'views/events/{universe}'])
    ...
    async def _get_summaries_async(self,
        ...
        _url = '/'.join([HistoricalPricing._URL_HISTORICALPRICING, 'views/interday-summaries/{universe}'])

        function_format_datetime = to_utc_date
        if interval:
            interval = _convert_interval_to_iso8601(interval)
            if interval in _INTRADAY:
                _url = '/'.join([HistoricalPricing._URL_HISTORICALPRICING, 'views/intraday-summaries/{universe}'])
