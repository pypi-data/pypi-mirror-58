...
import sys
import logging
from refinitiv.dataplatform.delivery.stream import ItemStream, StreamState
from refinitiv.dataplatform.delivery.stream.cache import StreamCache
from refinitiv.dataplatform.content.streaming.streamingprice_callback import StreamingPriceCallback
...
class StreamingPrice(StreamCache):
    ...
    class Params(object):
        ...
        def with_fields(self, fields):
            from refinitiv.dataplatform.function.tools import build_list
            if fields:
