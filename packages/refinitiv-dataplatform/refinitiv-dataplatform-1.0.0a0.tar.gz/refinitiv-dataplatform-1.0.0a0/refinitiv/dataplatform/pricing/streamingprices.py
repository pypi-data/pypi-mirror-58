...
class StreamingPrices:
    ...
    def __init__(self,
        ...
        if isinstance(universe, str):
            ...
            raise ElektronError(-1, "StreamingPrices: universe must be a list of strings")
        self._fields = fields
    ...
    async def open_async(self):
        ...
        self._session.log(1, f'StreamingPrices : start asynchrously streaming on {self.params.universe} done')
        return self._state
        ...
        if universe:
            for name in universe:
                if name not in self.params.universe:
                    raise ElektronError(-1, f'Instrument {name} was not requested : {self.params.universe}')
