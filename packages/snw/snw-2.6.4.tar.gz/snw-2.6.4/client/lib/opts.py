...
def define_option():
    ...
    subparsers_vocab = launcher.subparsers_map["vocab"].add_subparsers(help='sub-command help', dest='subcmd')
    ...
    parser_addtag_model.add_argument('-t', '--tags', nargs='+', type=str, help='tag names', required=True)
    ...
    parser_adddel_model.add_argument('-t', '--tags', nargs='+', type=str, help='tag names', required=True)
    ...
    parser_list_resources.add_argument('--aggr', action='store_true', help='aggregate file by suffixes')

    parser_get_resources = subparsers_resource.add_parser('get',
                                                          help='{gr} download a file from given storage')
    ...
    subparsers_tag = launcher.subparsers_map["tag"].add_subparsers(help='sub-command help', dest='subcmd')
