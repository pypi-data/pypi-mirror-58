...
setup(name='RegionProposalGenerator',
      ...
      url='https://engineering.purdue.edu/kak/distRPG/RegionProposalGenerator-1.0.4.html',
      download_url='https://engineering.purdue.edu/kak/distRPG/RegionProposalGenerator-1.0.4.tar.gz',
...
::
      ...
      classifiers=['Topic :: Scientific/Engineering :: Image Recognition', 'Programming Language :: Python :: 2.7', 'Programming Language :: Python :: 3.6'],
