...
class FracDiff(TransformerMixin):
    ...
    def __init__(self, order, window=10):
        """Initialize self."""
        # TODO default window = 10 sensible?
...
class StationarityTester:
    ...
    def score(self, X, y=None, value='pvalue'):
        ...
        - value : {'pvalue', 'statistics', 'all'}, default 'pvalue'
            'pvalue' : p-value.
            'all' : All return values from statsmodels.tsa.stattools.adfuller.
    ...
    def is_stationary(self, X, y=None, pvalue=.05):
        ...
        -------
        is_stationary : bool
            If True, the null hypothesis that a unit-root is present
            is rejected for a given pvalue.
        """
        if self.method == 'ADF':
