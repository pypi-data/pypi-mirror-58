...
class PostgreSQL:
    ...
    def update_table_client(self, table_client):
        self.cursor.execute("ALTER TABLE " + table_client +"ADD hash_code TEXT;")
        self.cursor.execute("ALTER TABLE " + table_client +"ADD project_name VARCHAR(500);")
    ...
    def get_url_from_hash(self, table_name="", project_name="", hash=""):
        try:
