...
# ----------------------------------------------------------------------
def build_stylesheet(theme='', light_secondary=False, resources=[]):
    """"""
...
# ----------------------------------------------------------------------
def apply_stylesheet(app, theme='', save_as=None, light_secondary=False, resources=[]):
    """"""
    app.setStyle("Fusion")
    stylesheet = build_stylesheet(theme, light_secondary, resources)
