    ...
    def _read(self,filename):
        ...
        for system in msgs.keys():# cycle through all keys
            ...
            for sensor in msgs[system]:# cycel through all sensors
                ...
                elif sensor == self.GPS: cols = self.WRAPPER_COLS+9
        ...
        while k < _len:# cycle through all messages
            ...
            if row >= msgs[skey][wrapper.getType()]['length']: continue# skip if out of range
            ...
            if wrapper.getType() == '$TFMAG':# QMAG messages
                ...
                if m.startswith(b'$GPGGA') or m.startswith(b'$GNGGA'):# all gpgga messages
                    gga.parse(m)
...
if __name__ == '__main__':
    r = tbsim0_reader()
    r.read(r'C:\Users\reynolds\Documents\1704_madunit\data\20190308_enfield01\log00001.log')
