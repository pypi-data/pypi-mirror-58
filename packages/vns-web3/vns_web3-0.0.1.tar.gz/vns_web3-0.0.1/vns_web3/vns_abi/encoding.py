...
from vns_abi.utils.numeric import (
    TEN,
    abi_decimal_context,
    ceil32,
...
from vns_abi.utils.padding import (
    fpad,
    zpad,
    zpad_right,
)
from vns_abi.utils.string import (
    abbr,
)
...
class BaseEncoder(BaseCoder, metaclass=abc.ABCMeta):
    ...
    def validate_value(self, value: Any) -> None:  # pragma: no cover
        """
        Checks zzz or not the given value can be encoded by this encoder.
