...
class NodeVisitor(parsimonious.NodeVisitor):
    ...
    def parse(self, type_str):
        ...
        :class:`~vns_abi.grammar.ABIType`.  If a type string cannot be parsed,
        throws :class:`~vns_abi.exceptions.ParseError`.

        :param type_str: The type string to be parsed.
        :returns: An instance of :class:`~vns_abi.grammar.ABIType` containing
...
class ABIType:
    ...
    def item_type(self):
        ...
        :class:`~vns_abi.grammar.ABIType` instance for the array's items.
        """
    ...
    def validate(self):  # pragma: no cover
        ...
        Raises :class:`~vns_abi.exceptions.ABITypeError` if validation fails.
        """
...
class TupleType(ABIType):
    ...
    def __init__(self, components, arrlist=None, *, node=None):
        ...
        """
        A tuple of :class:`~vns_abi.grammar.ABIType` instances for each of the
