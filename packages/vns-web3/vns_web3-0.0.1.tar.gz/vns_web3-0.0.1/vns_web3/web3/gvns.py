...
class GvnsPersonal(ModuleV2):
    """
    https://github.com/vnscoin/go-vnscoin/wiki/management-apis#personal
    """
    ecRecover = ecRecover
...
class GvnsTxPool(ModuleV2):
    """
    https://github.com/vnscoin/go-vnscoin/wiki/Management-APIs#txpool
    """
    content = content
    inspect = inspect
    status = status
...
class GvnsAdmin(ModuleV2):
    """
    https://github.com/vnscoin/go-vnscoin/wiki/Management-APIs#admin
    """
    add_peer = add_peer
    node_info = node_info
    start_rpc = start_rpc
...
class GvnsMiner(ModuleV2):
    """
    https://github.com/vnscoin/go-vnscoin/wiki/Management-APIs#miner
    """
    makeDag = makeDag
    setExtra = setExtra
    setVnserbase = setVnserbase
...
class GvnsShh(ModuleV2):
    """
    https://github.com/vnscoin/go-vnscoin/wiki/Whisper-v6-RPC-API
    """
