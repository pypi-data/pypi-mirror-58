...
from web3.tools.pytest_vnscoin._utils import (
    create_deployment_data,
    get_deployment_address,
    insert_deployment,
)
from web3.tools.pytest_vnscoin.exceptions import (
    LinkerError,
)

logger = logging.getLogger("pytest_vnscoin.linker")
...
def _deploy(
    ...
    tx_receipt = package.w3.vns.waitForTransactionReceipt(tx_hash)
