...
from vns_typing import HexStr, Primitives
from vns_typing.abi import TypeStr
...
from web3.vns import (
    Vns,
)
from web3.gvns import (
    Gvns,
    GvnsAdmin,
    GvnsMiner,
    GvnsPersonal,
...
class Web3:
    ...
    VnscoinTesterProvider = VnscoinTesterProvider
    ...
    def keccak(primitive: Primitives=None, text: str=None, hexstr: HexStr=None) -> bytes:
        if isinstance(primitive, (bytes, int, type(None))):
            ...
            return vns_utils_keccak(input_bytes)
