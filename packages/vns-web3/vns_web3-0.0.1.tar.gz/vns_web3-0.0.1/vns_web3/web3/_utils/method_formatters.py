...
PYTHONIC_REQUEST_FORMATTERS: Dict[RPCEndpoint, Callable[..., Any]] = {
    # Vns
    'vns_getBalance': apply_formatter_at_index(block_number_formatter, 1),
    ...
    'vns_call': apply_formatters_to_sequence([
        transaction_param_formatter,
        block_number_formatter,
    ]),
    ...
    'vns_getProof': apply_formatter_at_index(block_number_formatter, 2),
    # personal
...
PYTHONIC_RESULT_FORMATTERS: Dict[RPCEndpoint, Callable[..., Any]] = {
    # Vns
    'vns_accounts': apply_list_to_array_formatter(to_checksum_address),
    'vns_blockNumber': to_integer_if_hex,
    'vns_chainId': to_integer_if_hex,
    ...
    'vns_getProof': apply_formatter_if(is_not_null, proof_formatter),
...
METHOD_NORMALIZERS: Dict[RPCEndpoint, Callable[..., Any]] = {
    'vns_getLogs': apply_formatter_at_index(FILTER_PARAM_NORMALIZERS, 0),
    'vns_newFilter': apply_formatter_at_index(FILTER_PARAM_NORMALIZERS, 0)
}
