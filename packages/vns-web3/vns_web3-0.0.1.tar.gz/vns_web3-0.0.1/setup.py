...
setuptools.setup(
    name="vns_web3",                                     # 包的分发名称，使用字母、数字、_、-
    version="0.0.1",                                        # 版本号, 版本号规范：https://www.python.org/dev/peps/pep-0440/
    author="y19818",                                       # 作者名字
    author_email="y19818@gmail.com",                      # 作者邮箱
    description="vns web3.pyl",                            # 包的简介描述
    ...
    url="https://github.com/y19818/vns_web3.py",                              # 项目开源地址，我这里写的是同性交友官网，大家可以写自己真实的开源网址
