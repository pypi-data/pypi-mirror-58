...
class denoms:
    ...
    femtovnser = int(units["femtovnser"])
    mwei = int(units["mwei"])
    lovelace = int(units["lovelace"])
    picovnser = int(units["picovnser"])
    gwei = int(units["gwei"])
    shannon = int(units["shannon"])
    nanovnser = int(units["nanovnser"])
    nano = int(units["nano"])
    szabo = int(units["szabo"])
    microvnser = int(units["microvnser"])
    micro = int(units["micro"])
    finney = int(units["finney"])
    millivnser = int(units["millivnser"])
    milli = int(units["milli"])
    vnser = int(units["vnser"])
    kvnser = int(units["kvnser"])
    grand = int(units["grand"])
    mether = int(units["mether"])
    gvnser = int(units["gvnser"])
    tvnser = int(units["tvnser"])
