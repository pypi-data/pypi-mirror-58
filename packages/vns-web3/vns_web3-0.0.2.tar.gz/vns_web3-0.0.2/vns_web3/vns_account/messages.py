...
from vns_account._utils.structured_data.hashing import (
    hash_domain,
    hash_message as hash_eip712_message,
    load_and_validate_structured_message,
)
from vns_account._utils.validation import (
    is_valid_address,
)
...
def encode_structured_data(
    ...
    .. _EIP-712: https://eips.vnscoin.org/EIPS/eip-712
    """
...
def defunct_hash_message(
    ...
    .. CAUTION:: Intented for use with the deprecated :meth:`vns_account.account.Account.signHash`.
