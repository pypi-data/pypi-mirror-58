...
from vns_account.signers.base import (
    BaseAccount,
)
...
class LocalAccount(BaseAccount):
    ...
    def __init__(self, key, account):
        """
        :param vns_keys.PrivateKey key: to prefill in private key execution
        :param ~vns_account.account.Account account: the key-unaware management API
        """
    ...
    def privateKey(self):
        """
        .. CAUTION:: Deprecated for :var:`~vns_account.signers.local.LocalAccount.key`.
    ...
    def encrypt(self, password, kdf=None, iterations=None):
        ...
        :meth:`~vns_account.account.Account.encrypt`, but without a private key argument.
        """
    ...
    def sign_message(self, signable_message):
        """
        Generate a string with the encrypted key, as in
        :meth:`~vns_account.account.Account.sign_message`, but without a private key argument.
        """
