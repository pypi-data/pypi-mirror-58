...
class Table():
    def __init__(self, row={}):
        ...
        self.Settings = row.get("reloptions") or []
        self.Settings.append("OIDS=%s" % (str(self.HasOids).upper()))
    ...
    def DDL_Settings(self, style=""):
        ...
        if self.Settings is not None:
            for sts in sorted(self.Settings):
                sts = TableSettings(self.Schema, self.Name, sts)
                r.append(sts.DDL_Table(style))
