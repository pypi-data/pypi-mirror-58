...
# source: ks/service/predict.proto
...
PredictionRequest = _reflection.GeneratedProtocolMessageType('PredictionRequest', (_message.Message,), {
  ...
  '__module__' : 'ks.service.predict_pb2'
