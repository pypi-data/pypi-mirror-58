...
def get_network(weights):
    if weights == 'psnr-large':
        ...
        raise ValueError('Available RDN network weights: "psnr-small", "psnr-large", "noise-cancel"')
    c_dim = 3
    kernel_size = 3
    upscaling = 'ups'
