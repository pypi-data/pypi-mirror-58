...
class Workspace(object):
    ...
    * `What is a Azure Machine Learning
      workspace? <https://docs.microsoft.com/azure/machine-learning/service/concept-workspace>`_

    * `Manage access to a
      workspace <https://docs.microsoft.com/azure/machine-learning/service/how-to-assign-roles>`_

    * `Azure Machine Learning
      SKUs <https://docs.microsoft.com/azure/machine-learning/service/overview-what-is-azure-ml#sku>`_
    ...
    :param sku: The workspace SKU, which can be "basic" or "enterprise". For more information see `Azure Machine
        Learning SKUs <https://docs.microsoft.com/azure/machine-learning/service/overview-what-is-azure-ml#sku>`_.
    :type sku: str
    """
