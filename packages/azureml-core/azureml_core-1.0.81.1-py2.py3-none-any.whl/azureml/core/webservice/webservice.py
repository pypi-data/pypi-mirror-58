...
Learning](https://docs.microsoft.com/azure/machine-learning/service/how-to-deploy-and-where).
"""
...
class Webservice(ABC):
    ...
    with Azure Machine Learning <https://docs.microsoft.com/azure/machine-learning/service/how-to-deploy-and-where>`_.

    .. remarks::

        The following sample shows a common deployment pattern where you first create a configuration object with the
        ``deploy_configuration`` method of the child class of Webservice (in this case
        :class:`azureml.core.webservice.AksWebservice`) and then use the configuration with one of the ``deploy*``
        ...
        https://github.com/Azure/MachineLearningNotebooks/blob/master/how-to-use-azureml/deployment/accelerated-models/accelerated-models-training.ipynb
        ...
        The examples above showed two ways to deploy a web service endpoint. The options for deployment include:
    ...
    def deploy(workspace, name, model_paths, image_config, deployment_config=None, deployment_target=None,
        ...
        service <https://docs.microsoft.com/azure/machine-learning/service/how-to-consume-web-service>`_.
        ...
        :type deployment_config: azureml.core.webservice.WebserviceDeploymentConfiguration
    ...
    def deploy_from_image(workspace, name, image, deployment_config=None, deployment_target=None, overwrite=False):
        ...
        if deployment_target is None:
            ...
            return deployment_config._webservice_type._deploy(workspace, name, image, deployment_config, overwrite)
    ...
    def serialize(self):
        ...
        return {'name': self.name, 'description': self.description, 'tags': self.tags,
                ...
                'imageDetails': image_details, 'scoringUri': self.scoring_uri, 'createdBy': self.created_by}
