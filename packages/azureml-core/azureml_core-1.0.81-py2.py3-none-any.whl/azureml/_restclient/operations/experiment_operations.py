...
class ExperimentOperations(object):
    ...
    def list(
            self, subscription_id, resource_group_name, workspace_name, filter=None, continuation_token=None, orderby=None, sortorder=None, top=None, view_type=None, custom_headers=None, raw=False, **operation_config):
        """
