...
If you want to use rbql module as a python library for your own app - read the API and integration [Documentation](https://github.com/mechatroner/rbql-py/blob/master/PYLIBRARY.md)  
