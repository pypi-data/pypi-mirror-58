...
class StartModule():
    ...
    def getIPListfromServices(self, serviceName, shodan_api=None, is_worker=False, stop_flag=False):
        if not is_worker:
            ...
            while True:
                Logger.printMessage(self.getIPListfromServices(serviceName, shodan_api), debug_module=True)
                if stop_flag:
                    break
