...
class PyAnalyticsApi:
    ...
    @staticmethod
    def create_list_of_ts_api_defs(item_ids: List[int], item_type: str, measure_name: str, data_type: str,
                                   day: datetime = None,
        ...
        for it_id in item_ids:
            list_res.append(
                TSApiDef(it_id, item_type, measure_name, data_type, day, from_date, to_date))
        return list_res
