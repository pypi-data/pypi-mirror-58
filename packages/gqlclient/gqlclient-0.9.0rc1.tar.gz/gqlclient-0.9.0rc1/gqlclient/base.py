...
from gqlclient.exceptions import GraphQLException, ModelException
...
class GraphQLClientBase(ABC):
    ...
    def _format_response(self, query_base: str, response_cls, result: dict, response_encoder: Union[Callable, None]):
        """
