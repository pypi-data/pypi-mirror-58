...
setup(
    ...
    description="Type annotations for boto3.CodeStarconnections 1.10.46 service.",
    classifiers=[
    ...
    keywords="boto3 codestar-connections type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
