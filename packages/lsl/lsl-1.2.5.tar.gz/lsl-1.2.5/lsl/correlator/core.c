...
static PyObject *PFBEngineR2(PyObject *self, PyObject *args, PyObject *kwds) {
	PyObject *signals, *freqs, *delays, *signalsF, *window=Py_None;
	PyArrayObject *data=NULL, *freq=NULL, *delay=NULL, *dataF=NULL, *validF=NULL;
	int nChan = 64;
	int Overlap = 1;
	int Clip = 0;
	...
	long ij, i, j, k, l, nStand, nSamps, nFFT;
...
static PyObject *PFBEngineC2(PyObject *self, PyObject *args, PyObject *kwds) {
	PyObject *signals, *freqs, *delays, *signalsF, *window=Py_None;
	PyArrayObject *data=NULL, *freq=NULL, *delay=NULL, *dataF=NULL, *validF=NULL;
	int nChan = 64;
	int Overlap = 1;
...
static PyMethodDef CorrelatorMethods[] = {
	...
	{"PFBEngineR2", (PyCFunction) PFBEngineR2, METH_VARARGS|METH_KEYWORDS, PFBEngineR2_doc}, 
	...
	{"PFBEngineC2", (PyCFunction) PFBEngineC2, METH_VARARGS|METH_KEYWORDS, PFBEngineC2_doc}, 
...
The function defined in this module are:\n\
  ...
  * FEngineR3 - Similar to FEngineR2, but allows for a window function to be applied\n\
    to the data.\n\
  * PFBEngineR2 - Similar to FEngineR2, but using a 4-tap + Hanning windowed polyphase\n\
    filter bank.\n\
  ...
  * FEngineC3 - Similar to FEngineC2, but allows for a window function to be applied\n\
    to the data.\n\
  * PFBEngineC2 - Similar to FEngineC2, but using a 4-tap + Hanning windowed polyphase\n\
    filter bank.\n\
