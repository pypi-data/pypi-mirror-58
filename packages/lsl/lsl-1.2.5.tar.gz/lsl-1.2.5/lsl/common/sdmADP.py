...
class SubSubSystemStatus(object):
    ...
    def binaryRead(self, fh, overrides=None):
        """
        Given an open file handle, interpret it in the context of a 
        ...
        ssssStruct = parseCStruct(SUBSUBSYSTEM_STATUS_STRUCT, endianness='little', overrides=overrides)
...
def parseSDM(filename):
    ...
    with open(filename, 'rb') as fh:
        ...
        try:
            ...
            # Sub-sub-system status section
            dynamic.status.binaryRead(fh, overrides=overrides)
