...
class FrameHeader(object):
    ...
    def getTime(self):
        ...
        frameMJD_i = epochMJD + self.secondsFromEpoch // 86400
        frameMJD_f = (self.secondsFromEpoch % 86400) / 86400.0
        ...
        if self.sampleRate == 0.0:
            ...
            try:
                ...
                sampleRate *= 1e6 if eud['sampleRateUnits'] == 'MHz' else 1e3
                ...
                nSamples = nSamples / self.nChan / (2 if self.isComplex else 1) # data samples -> time samples
                
                ## What is the frame rate?
                frameRate = sampleRate // nSamples
                
                frameMJD_f += 1.0*self.frameInSecond/frameRate/86400.0
        ...
        if frameMJD_f > 1:
            frameMJD_i += 1
            frameMJD_f -= 1
        seconds = int(astro.utcjd_to_unix(frameMJD_i + astro.MJD_OFFSET))
        seconds += frameMJD_f * 86400.0
