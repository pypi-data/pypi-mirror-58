...
from lsl.writer.measurementset import NumericStokes as NumericStokesMS
...
try:
    ...
    class CorrelatedDataMS(object):
        ...
        def __init__(self, filename):
            ...
            # Catch multi-spectral window data sets
            if len(self._windows) > 1:
                raise RuntimeError("MeasurementSet with more than one spectral window are not supported")
