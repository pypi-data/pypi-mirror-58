...
{
       0,   188,   188,   192,   193,   197,   198,   202,   203,   207,
     208,   209,   213,   272,   276,   298,   348,   383,   384,   388
};
#endif
...
{
  "$end", "error", "$undefined", "XML_ATTRIBUTE_ASSIGN", "XML_COMMENT",
  "XML_DOCTYPE", "XML_PROLOGUE", "XML_TAG_END", "XML_TAG_END_SINGLE",
  "XML_ATTRIBUTE_NAME", "XML_ATTRIBUTE_VALUE", "XML_TAG_CLOSE",
  "XML_TAG_CONTENT", "XML_TAG_OPEN_START", "$accept", "xml_plist_main",
  "xml_prologue", "xml_doctype", "xml_tags", "xml_tag",
  "xml_tag_open_start", "xml_tag_open", "xml_tag_single", "xml_tag_close",
  "xml_tag_content", "xml_attributes", "xml_attribute", YY_NULLPTR
};
#endif
...
{
      -1,   -18,    11,     7,   -18,   -18,     1,   -18,     4,     1,
      12,     9,     4,     6,     1,     4,   -11,   -18,     8,   -18,
     -18,   -18,   -18,   -18,     0,   -18,     6,     6,   -18,   -18,
     -18,   -18
};
...
{
      20,    25,     7,    24,    23,     1,    26,    19,    29,    30,
      31,     4,     5,    10,     7,    18,    19,    21,    28,     8,
       9
};

static const yytype_uint8 yycheck[] =
{
      12,    12,    13,    15,    14,     6,    16,     7,     8,    26,
      27,     0,     5,     9,    13,     3,     7,    11,    10,     6,
       6
};
...
{
       0,     6,    15,    16,     0,     5,    17,    13,    20,    21,
       9,    25,    26,    18,    19,    20,    21,    22,     3,     7,
      25,    11,    23,    18,    25,    12,    18,    24,    10,     8,
      23,    23
};
