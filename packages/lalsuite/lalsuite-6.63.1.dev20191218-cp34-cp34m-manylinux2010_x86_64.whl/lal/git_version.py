...
id = "505df9dd2e69b4812f1e8eee3a6d468ba7f80674"
date = "2019-12-17 21:10:46 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "505df9dd2e69b4812f1e8eee3a6d468ba7f80674":
        return
    msg = "Program id (505df9dd2e69b4812f1e8eee3a6d468ba7f80674) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
