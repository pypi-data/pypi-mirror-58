...
id = "df0f71c595557e2181916e9094ffdd34b061686b"
date = "2019-12-21 00:57:23 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "df0f71c595557e2181916e9094ffdd34b061686b":
        return
    msg = "Program id (df0f71c595557e2181916e9094ffdd34b061686b) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
