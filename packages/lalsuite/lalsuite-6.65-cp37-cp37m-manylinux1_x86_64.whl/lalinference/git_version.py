...
id = "667dfe84771e1e3028983f1daecd904c835ca1a6"
date = "2019-12-20 18:11:57 +0000"
branch = "None"
tag = "lalsuite-v6.65"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "667dfe84771e1e3028983f1daecd904c835ca1a6":
        return
    msg = "Program id (667dfe84771e1e3028983f1daecd904c835ca1a6) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
