...
id = "397a5c80feb7c56e53ff112dfb7b02ec8630d167"
date = "2019-12-19 17:01:33 +0000"
branch = "None"
tag = "lalsuite-v6.64"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "397a5c80feb7c56e53ff112dfb7b02ec8630d167":
        return
    msg = "Program id (397a5c80feb7c56e53ff112dfb7b02ec8630d167) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
