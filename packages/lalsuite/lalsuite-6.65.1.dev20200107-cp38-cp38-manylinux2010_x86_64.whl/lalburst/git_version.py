...
id = "b74158c0991970ca7f26a722d94ad742743f4daa"
date = "2020-01-6 15:49:27 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "b74158c0991970ca7f26a722d94ad742743f4daa":
        return
    msg = "Program id (b74158c0991970ca7f26a722d94ad742743f4daa) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
