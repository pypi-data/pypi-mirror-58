...
setup(
    ...
    license='MIT',
    version='0.1',
    description="BioSTEAM's premier repository for biorefinery models",
    ...
    url='https://github.com/yoelcortes/Bioindustrial-Complex/biorefineries',
    download_url='https://github.com/yoelcortes/Bioindustrial-Complex/biorefineries.git',
