...
class ListAssessmentRunAgentsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListAssessmentRunAgents.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/inspector.html#Inspector.Paginator.ListAssessmentRunAgents.paginate)
        """
...
class ListAssessmentRunsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListAssessmentRuns.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/inspector.html#Inspector.Paginator.ListAssessmentRuns.paginate)
        """
...
class ListAssessmentTargetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListAssessmentTargets.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/inspector.html#Inspector.Paginator.ListAssessmentTargets.paginate)
        """
...
class ListAssessmentTemplatesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListAssessmentTemplates.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/inspector.html#Inspector.Paginator.ListAssessmentTemplates.paginate)
        """
...
class ListEventSubscriptionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListEventSubscriptions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/inspector.html#Inspector.Paginator.ListEventSubscriptions.paginate)
        """
...
class ListExclusionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListExclusions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/inspector.html#Inspector.Paginator.ListExclusions.paginate)
        """
...
class ListFindingsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListFindings.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/inspector.html#Inspector.Paginator.ListFindings.paginate)
        """
...
class ListRulesPackagesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListRulesPackages.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/inspector.html#Inspector.Paginator.ListRulesPackages.paginate)
        """
...
class PreviewAgentsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [PreviewAgents.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/inspector.html#Inspector.Paginator.PreviewAgents.paginate)
        """
