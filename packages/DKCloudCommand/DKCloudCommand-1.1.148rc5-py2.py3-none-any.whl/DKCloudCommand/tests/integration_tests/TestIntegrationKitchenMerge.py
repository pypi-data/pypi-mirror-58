...
class TestIntegrationKitchenMerge(BaseTestCloud):
    ...
    def _init(self, merge_type):
        ...
        self.conflicted_file = DKPathHelper.normalize('resources/very_cool.sql', DKPathHelper.WIN)
        self.conflicted_file_new = DKPathHelper.normalize(
            'resources/deeper/very_cool_002.sql', DKPathHelper.WIN
        )
        self.conflicted_file_new2 = DKPathHelper.normalize(
            'resources/deeper2/very_cool_002_2.sql', DKPathHelper.WIN
        )
    ...
    def _merge_preview(self, resolved=False, conflict_list=None, cpr=False, reverse=False):
