...
class UniconRobot(object):
    ...
    @keyword('set unicon setting "${key}" "${value}" on device "${devices}"')
    ...
    @keyword('set unicon setting "${key}" "${value}" on device "${devices} via "${via:[^"]+}"')
    ...
    @keyword('set unicon setting "${key}" "${value}" on device "${devices} as alias "${alias:[^"]+}"')
    ...
    @keyword('set unicon setting "${key}" "${value}" on device "${devices} via "${via:[^"]+}" as alias "${alias}"')
