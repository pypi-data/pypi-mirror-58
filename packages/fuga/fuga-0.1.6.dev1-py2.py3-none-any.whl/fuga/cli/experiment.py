...
class ExperimentDeployCommand:
    ...
    def run(self):
        ...
        # Add experiment config file
        experiment_config_file_path = os.path.join(experiment_root_dir, 'fuga.yml')
        if os.path.isfile(experiment_config_file_path):
            pairs.append(
                (
            ...
            raise Exception(f"Couldn't find fuga config file at f{experiment_config_file_path}")
