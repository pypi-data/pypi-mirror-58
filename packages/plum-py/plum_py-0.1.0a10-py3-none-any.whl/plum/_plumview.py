...
from ._plum import _pack_freeform, unpack_from, pack_freeform
...
class PlumView:
    ...
    def set(self, value):
        ...
        """
        membytes = pack_freeform(self.__type__, value)
