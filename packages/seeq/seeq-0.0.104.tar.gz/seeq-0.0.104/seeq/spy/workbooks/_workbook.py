...
class Workbook(ItemWithOwnerAndAcl):
    ...
    def refresh_from(self, new_item, item_map):
        ...
        new_inventory = dict()
        for inventory_item_id, inventory_item in self.scope_inventory.items():
            ...
            new_inventory_item = new_item.scope_inventory[new_inventory_item_id]
            inventory_item.refresh_from(new_inventory_item, item_map)
            new_inventory[new_inventory_item_id] = inventory_item

        self.scope_inventory = new_inventory
    ...
    def push(self, *, owner=None, folder_id=None, item_map=None, label=None,
        ...
        workbook_item = Item.find_item(self.id, label)
    ...
    def _scrape_scope_inventory(self):
        ...
        if 'Ancestors' in self:
            for ancestor_id in self['Ancestors']:
                ...
                self.scope_inventory[ancestor_id] = item
    ...
    def _scrape_inventory_from_item(self, item_id):
        ...
        self.scope_inventory[item_id] = item
        ...
        for dependency in dependencies:
            ...
            self.scope_inventory[dependency.id] = dep_item
