    ...
    def refresh_from(self, new_item, item_map):
        ...
        for inventory_item_id, inventory_item in self.scope_inventory.copy().items():
            if inventory_item_id not in item_map:
                # Folders may not have been pushed (depending on spy.workbooks.push arguments) and therefore won't be
                # in the map, so skip them.
                continue
            ...
            del new_inventory[new_inventory_item_id]
