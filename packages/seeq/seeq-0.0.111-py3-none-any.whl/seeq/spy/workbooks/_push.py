...
def push(workbooks, *, path=None, owner=None, label=None, datasource_map_folder=None,
         ...
         include_inventory=True, scope_globals_to_workbook=True, refresh=True,
    ...
    scope_globals_to_workbook : bool, default True
        ...
        will be scoped to the workbook. Set this to False if you want to
