...
class MsgHeartBeat(ctypes.Structure):
    ...
    def __str__(self):
        return '<hb fist_type={} fist_name={} desc_name={} hb_status={}>'.format(
            FistType.read(self.fist_type), self.fist_name, self.desc_name, HeartBeatStatus.read(self.hb_status)
        )
...
class ReqCommand:
    ...
    def __init__(self, d=None):
        ...
        self.target_fist_type = None if d is None else FistType.parse(d['target_fist_type'])
    ...
    def to_dict(self):
        return {
            ...
            'target_fist_type': FistType.read(self.target_fist_type),
