...
class ListBootstrapActionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListBootstrapActions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.42/reference/services/emr.html#EMR.Paginator.ListBootstrapActions.paginate)
        """
...
class ListClustersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListClusters.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.42/reference/services/emr.html#EMR.Paginator.ListClusters.paginate)
        """
...
class ListInstanceFleetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListInstanceFleets.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.42/reference/services/emr.html#EMR.Paginator.ListInstanceFleets.paginate)
        """
...
class ListInstanceGroupsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListInstanceGroups.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.42/reference/services/emr.html#EMR.Paginator.ListInstanceGroups.paginate)
        """
...
class ListInstancesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListInstances.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.42/reference/services/emr.html#EMR.Paginator.ListInstances.paginate)
        """
...
class ListSecurityConfigurationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListSecurityConfigurations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.42/reference/services/emr.html#EMR.Paginator.ListSecurityConfigurations.paginate)
        """
...
class ListStepsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListSteps.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.42/reference/services/emr.html#EMR.Paginator.ListSteps.paginate)
        """
