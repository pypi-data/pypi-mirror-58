...
# processes: number of parallel processes. Default=4
#
def upload_jsons(api_instance, dataset, json_iter, language="", processes=4):
    try:
        api_response = api_instance.post_bulk_insert_json({"dataset":dataset,"language":language,"documents":list(json_iter)})
        return [api_response.result]
    except ApiException as e:
...
class NucleusApi(object):
    ...
    def poll_job_status(self, job_id):
        ...
        while result == None:
            ...
            if i % 60 == 0:
                print('INFO: The job has been running for', i / 60, 'minutes')
    ...
    def get_job_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if job_id == None:
            ...
            if res.result == None and response_type != 'JobRespModel':
    ...
    def post_upload_file(self, file, dataset, **kwargs):  # noqa: E501
        ...
        :param str metadata: Optional json containing additional document metadata. Eg: {\"time\":\"01/01/2001\",\"author\":\"me\"}.Document selection based on metadata will be case-insensitive.
        ...
        :param str time: Specify the timestamp of the document (defaults to current timestamp)
    ...
    def post_upload_file_with_http_info(self, file, dataset, **kwargs):  # noqa: E501
        ...
        all_params = ['file', 'dataset', 'metadata', 'filename', 'time']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
