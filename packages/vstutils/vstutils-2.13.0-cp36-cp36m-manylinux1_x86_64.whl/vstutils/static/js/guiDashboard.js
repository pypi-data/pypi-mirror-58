let guiWidgets={};guiWidgets.base=class BaseWidget{constructor(options={}){this.format='base';this.sort=0;this.active=true;this.collapsed=false;this.collapsable=true;this.name=options.name;this.title=options.title;['active','collapsed','sort'].forEach(key=>{if(options[key]!==undefined){this[key]=options[key];}});}};guiWidgets.counter=class CounterWidget extends guiWidgets.base{constructor(options={}){super(options);this.format='counter';this.collapsable=false;this.url=options.url;}};guiWidgets.line_chart=class LineChartWidget extends guiWidgets.base{constructor(options){super(options);this.format='line_chart';this.chart_type='line';this.chart_options=options.chart_options||{};this.lines=options.lines||[];}
