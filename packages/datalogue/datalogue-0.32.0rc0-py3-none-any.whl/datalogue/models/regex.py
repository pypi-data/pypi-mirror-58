...
class Regex:
    ...
    def __init__(
            ...
            test_data: Optional[Union[List[str], List[RegexTestSample]]] = None,
...
class RegexShare:
    """
    This is a class that represents a Regex permission.
    ...
    def __init__(
        ...
        """
        The constructor for RegexShare class.
    ...
    def __repr__(self):
        return(f'{self.permission!r} permissions for this regex are extended to '
               f'target {self.target_type!r} ' 
               f'with id: {self.target_id!r}')

    @staticmethod
    def from_payload(payload: dict) -> Union[DtlError, 'RegexShare']:
        ...
        return RegexShare(target_id, target_type, permission)
