...
from datalogue.utils import _parse_list, _parse_string_list, SerializableStringEnum, _parse_uuid
...
class Deployment:
    def __init__(self, id: UUID, ontology_id: UUID, training_id: UUID, model_type: ModelType, status: str, created_at: datetime):
        self.id = id
    ...
    def __repr__(self):
        return f"(id: {self.id}, ontology_id: {self.ontology_id}, training_id: {self.training_id}," \
    ...
    def _from_payload(json: dict) -> Union[DtlError, 'Deployment']:
        ...
        training_id = json.get("trainingId")
