...
class Main(wx.Panel):
    ...
    def __init__(self, parent, Module, pubsub1, pubsub2):
        ...
        self.button5 = wx.Button(self, label = 'Start Amb', size = (90, 30), id =12) #Stop/Start button - Data Acquisition
        self.button5.SetFont(self.font2)
        ...
        self.one = wx.SpinCtrlDouble(self, size=(80,-1), min =-400, max = 800, inc = 0.1, value='25')
        ...
        self.button10 = wx.Button(self, label = 'Start N2', size = (90, 30), id =67) #Stop/Start button - Data Acquisition
        ...
        self.four = wx.SpinCtrlDouble(self, size=(80,-1), min =-400, max = 800, inc = 0.1, value='180.001')
