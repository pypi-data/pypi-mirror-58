...
class AdvertsTab(TableTab):
    ...
    def __init__(self, data, parent=None):
        ...
        edition_group_hbox.addWidget(self.mapped_widgets[self.data.headers.index("Cons")])
        edition_group_hbox.addWidget(self.mapped_widgets[self.data.headers.index("Pros")])
