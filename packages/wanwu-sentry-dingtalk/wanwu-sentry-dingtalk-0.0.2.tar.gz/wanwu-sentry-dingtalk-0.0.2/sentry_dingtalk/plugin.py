...
class DingtalkPlugin(notify.NotificationPlugin):
    ...
    resource_links = [
        ('Bug Tracker', 'zhaoxiaolong@zhuangdianwenhua.com'),
    ...
    def notify_users(self, group, event, *args, **kwargs): 
        ...
        # message = message_format % (event.platform, event.message, link)
        data = {
                    "msgtype": "link",
                    "link": {
                        "text": event.message,
