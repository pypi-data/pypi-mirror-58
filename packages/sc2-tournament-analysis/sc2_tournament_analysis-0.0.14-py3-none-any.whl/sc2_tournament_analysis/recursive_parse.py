    ...
    *,
        ...
        for rule, rule_type in player_match:
            ...
            if rule_type == 'search':
                ...
                if current_name_str and type(current_name_str) is list:
                    ...
                    player_names = None
        return identifiers, player_names
    ...
    def recurse(path, player_names=[], identifiers=[]):
        if path.is_dir():
            ...
            identifiers, result = check_dir_name(current_path_str, player_names, identifiers)
            if result:
                player_names = result
            ...
            for item in path.iterdir():
                ...
                item_identifiers, result = check_dir_name(item_path_str, player_names, identifiers)
                if result:
                    player_names = result
