...
class Opssat1(KaitaiStruct):
    ...
    class UiFrame(KaitaiStruct):
        ...
        def _read(self):
            ...
            if _on == u"DP0OPS":
                self.info = self._root.OpssatPayloadDscrm(self._io, self, self._root)
    ...
    class OpssatPayloadDscrm(KaitaiStruct):
        ...
        def _read(self):
            ...
            io = KaitaiStream(BytesIO(self._raw_payload_dscrm))
            self.payload_dscrm = self._root.OpssatPayload(io, self, self._root)
