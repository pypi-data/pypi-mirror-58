...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v1.7.0-alpha.1578234237+gcd7313d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v1.7.0-alpha.1578234237+gcd7313d`
                """)
            else:
                raise
