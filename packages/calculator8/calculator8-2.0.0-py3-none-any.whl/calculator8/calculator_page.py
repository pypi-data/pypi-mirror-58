"""
 ...
 # @LastEditTime: 2019-12-18 18:18:18
 # @FilePath: \calculator2.1.0\packages\calculator_page.py
"""

from tkinter import *
from calculator8 import standard_page
from calculator8 import science_page
from calculator8 import programmer_page
from calculator8 import calculator_date_page
...
class CalcPage(object):
    ...
    def main_page(self):
        ...
        """
        self.standard_page = standard_page.StandardFrame(self.root)  # 创建不同Frame
        self.science_page = science_page.ScienceFrame(self.root)
        self.programmer_page = programmer_page.Programmer(self.root)
        self.date_calculator_page = calculator_date_page.dateFrame(self.root)
