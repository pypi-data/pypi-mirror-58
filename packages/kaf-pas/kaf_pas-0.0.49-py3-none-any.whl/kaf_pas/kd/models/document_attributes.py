...
class Document_attributesManager(CommonManagetWithLookUpFieldsManager):
    @staticmethod
    def get_or_create_attribute(attr_codes, attr_names, value_str,  logger=None):
        ...
        attribute, create = Document_attributes.objects.get_or_create(
            attr_type=attr_type,
            value_str=value_str,
            value_int=value_int
        )
        ...
        #     logger.logging(f'\nAdded Document_attributes: {attribute}', 'debug')
