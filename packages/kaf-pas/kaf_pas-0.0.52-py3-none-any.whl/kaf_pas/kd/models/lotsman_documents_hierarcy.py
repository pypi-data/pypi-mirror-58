...
class Lotsman_documents_hierarcyManager(AuditManager):
    ...
    def make_items(document, logger, owner=None):
        ...
        with transaction.atomic():
            ...
            parent, created = Item.objects.get_or_create(STMP_1=Document_attributesManager.get_or_create_attribute(
                attr_codes='STMP_1',
            ...
            Item_refs.objects.get_or_create(child=parent)
            ...
            if cnt > 0:
                ...
                for lotsman_documents_hierarcy in Lotsman_documents_hierarcy_view.objects_tree.get_descendants(
                    ...
                    STMP_1_id = lotsman_documents_hierarcy.STMP_1_id
                    STMP_2_id = lotsman_documents_hierarcy.STMP_2_id
                    ...
                    item_line, created = Item_line.objects.get_or_create(
                        ...
                        child=item,
                        defaults=dict(
                            SPC_CLM_FORMAT_id=lotsman_documents_hierarcy.SPC_CLM_FORMAT_id,
                            SPC_CLM_ZONE_id=lotsman_documents_hierarcy.SPC_CLM_ZONE_id,
                            SPC_CLM_POS_id=lotsman_documents_hierarcy.SPC_CLM_POS_id,
                            SPC_CLM_MARK_id=lotsman_documents_hierarcy.SPC_CLM_MARK_id,
                            SPC_CLM_NAME_id=lotsman_documents_hierarcy.SPC_CLM_NAME_id,
                            SPC_CLM_COUNT_id=lotsman_documents_hierarcy.SPC_CLM_COUNT_id,
                            SPC_CLM_NOTE_id=lotsman_documents_hierarcy.SPC_CLM_NOTE_id,
                            SPC_CLM_MASSA_id=lotsman_documents_hierarcy.SPC_CLM_MASSA_id,
                            SPC_CLM_MATERIAL_id=lotsman_documents_hierarcy.SPC_CLM_MATERIAL_id,
                            SPC_CLM_USER_id=lotsman_documents_hierarcy.SPC_CLM_USER_id,
                            SPC_CLM_KOD_id=lotsman_documents_hierarcy.SPC_CLM_KOD_id,
                            SPC_CLM_FACTORY_id=lotsman_documents_hierarcy.SPC_CLM_FACTORY_id,
