...
def Lotsman_documents_hierarcy_ReloadDoc(request):
    ...
    r = requests.get(f'{settings.KOMPAS_INFORMICA}/logic/Lotsman_documents_hierarcy/ReloadDoc', params=dict(ids=ids, port=ws_port, ws_channel=ws_channel, host=host, user_id=request.user_id))
