...
class ApartmentTab(TableTab):
    ...
    def __init__(self, data, parent=None):
        ...
        edition_group_vbox.addWidget(self.mapped_widgets[self.data.headers.index("GPS")])
        edition_group_vbox.addLayout(edition_group_hbox)
        edition_group_hbox.addWidget(self.mapped_widgets[self.data.headers.index("Moins")])
        edition_group_hbox.addWidget(self.mapped_widgets[self.data.headers.index("Plus")])
