...
class DQMask:
    ...
    Note: x = DQMask(value, declass=True) gives the same result.
    -----------
    ...
    -----------
    Note: assume that data are recorded as one base class, not a combine class
    """
    def __init__(self,value=[0],declass=False):
