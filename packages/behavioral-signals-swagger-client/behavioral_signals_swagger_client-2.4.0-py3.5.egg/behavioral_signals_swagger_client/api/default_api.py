...
class DefaultApi(object):
    ...
    def send_process_audio(self, cid, file, channels, calldirection, **kwargs):  # noqa: E501
        ...
        :param int asr: 0 for false, 1 for true
        :return: Process
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def send_process_audio_with_http_info(self, cid, file, channels, calldirection, **kwargs):  # noqa: E501
        ...
        all_params = ['cid', 'file', 'channels', 'calldirection', 'name', 'customer_id', 'customer_ind', 'agent_team', 'agent_id', 'campaign_id', 'calltype', 'ani', 'calltime', 'timezone', 'storedata', 'tag', 'meta', 'asr']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'asr' in params:
            query_params.append(('asr', params['asr']))  # noqa: E501
    ...
    def send_process_tcp_with_http_info(self, cid, channels, calldirection, **kwargs):  # noqa: E501
        ...
        all_params = ['cid', 'channels', 'calldirection', 'name', 'customer_id', 'customer_ind', 'agent_team', 'agent_id', 'campaign_id', 'calltype', 'ani', 'calltime', 'timezone', 'storedata', 'tag', 'meta', 'asr']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def send_process_url_with_http_info(self, cid, url, channels, calldirection, **kwargs):  # noqa: E501
        ...
        all_params = ['cid', 'url', 'channels', 'calldirection', 'name', 'customer_id', 'customer_ind', 'agent_team', 'agent_id', 'campaign_id', 'calltype', 'ani', 'calltime', 'timezone', 'storedata', 'tag', 'meta', 'asr']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
