...
class HomePageView(View):
    ...
    def get(self, request, *args, **kwargs):
        article = Article('djangoarticle', settings.APIKEY)
        post = Article('djangopost', settings.APIKEY)
        ...
        promo = sorted(chain(article_promo, post_promo), key=lambda instance: instance['serial'])
        ...
        is_trending = sorted(chain(article_trending, post_trending), key=lambda instance: instance['serial'])
