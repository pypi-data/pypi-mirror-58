...
def get_first_name(gender = None):
	firstNameFile = csv.reader(open(full_path('randominfo\\data.csv'), 'r'))
	filteredData = []
	if gender == None:
...
def get_last_name():
	lastNameFile = csv.reader(open(full_path('randominfo\\data.csv'), 'r'))
	filteredData = []
...
def get_address():
	...
	for i in range(4,10):
		addrFile = csv.reader(open(full_path('randominfo\\data.csv'), 'r'))
		allAddrs = []
...
def get_hobbies():
	hobbiesFile = csv.reader(open(full_path('randominfo\\data.csv'), 'r'))
	allHobbies = []
