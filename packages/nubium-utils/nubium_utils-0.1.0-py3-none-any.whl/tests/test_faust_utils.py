...
class TestFaustAppWrapper(unittest.TestCase):
    ...
    def test_app_creation(self):
        ...
        mock_metrics_pusher = mock.MagicMock()

        app_wrapper = ImplementedAppWrapper(test_faust_config, avro_client=None, metrics_manager=mock_monitor, metrics_pusher=mock_metrics_pusher)
