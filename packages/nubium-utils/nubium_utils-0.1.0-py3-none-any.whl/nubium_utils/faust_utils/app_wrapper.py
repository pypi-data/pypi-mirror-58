...
from nubium_utils.metrics import MetricsPusher, MetricsManager
...
class FaustAppWrapper(ABC):
    ...
    def __init__(self, faust_config, avro_client, metrics_manager: MetricsManager, metrics_pusher: MetricsPusher):
