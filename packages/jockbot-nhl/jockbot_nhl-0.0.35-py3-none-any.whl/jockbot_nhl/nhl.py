...
class NHL:
    ...
    def __init__(self):
        ...
        self.live_scores = _game_scores(status='Live', games=self.todays_games, linescore=True)
        self.recent_scores = _game_scores(status='Final', games=self.recent_games, linescore=True)
    ...
    def skater_league_leaders(self, stat, **kwargs):
        ...
        num_players: number of leaders to return. ex. num_players=5
                     (default is 10)
        """
        leaders = _skater_league_leaders(stat, **kwargs)
        return leaders
...
class NHLTeam(NHL):
    ...
    def __init__(self, team=None):
        ...
        # self.all_games = _parse_team_games(self.get_team_schedule(team_id=self.id))
