...
class PricingClient(BaseClient):
    """
    [Pricing.Client documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/pricing.html#Pricing.Client)
    """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Client.can_paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/pricing.html#Pricing.Client.can_paginate)
        """
    ...
    def describe_services(
        ...
        """
        [Client.describe_services documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/pricing.html#Pricing.Client.describe_services)
        """
    ...
    def generate_presigned_url(
        ...
        """
        [Client.generate_presigned_url documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/pricing.html#Pricing.Client.generate_presigned_url)
        """
    ...
    def get_attribute_values(
        ...
        """
        [Client.get_attribute_values documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/pricing.html#Pricing.Client.get_attribute_values)
        """
    ...
    def get_products(
        ...
        """
        [Client.get_products documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.40/reference/services/pricing.html#Pricing.Client.get_products)
        """
