...
def parseCommandLine():
    ...
    parser.add_argument('-m', dest='mirror_tld', default='/mirror1/repos', help='Base directory to store repos; default: %(default)s')
    parser.add_argument('-r', dest='repo_name', help='repo name for storing packages in', required=True)
    parser.add_argument('-u', dest='repo_url', default='https://pypi.org', help='URL of pypi index site; default: %(default)s')
    parser.add_argument('-t', dest='thread_count', type=int, default=5, help='Number of threads to use for downloading files; default: %(default)s')
