...
if telemetry_enabled:
    WHITELISTED_PROPERTIES.extend(StandardFieldKeys.keys())
    WHITELISTED_PROPERTIES.remove(StandardFieldKeys.WORKSPACE_REGION_KEY)

    WHITELISTED_PROPERTIES.extend(_AutoMLExtensionFieldKeys.keys())
    WHITELISTED_PROPERTIES.remove(_AutoMLExtensionFieldKeys.TRACEBACK_MESSAGE_KEY)
    WHITELISTED_PROPERTIES.remove(_AutoMLExtensionFieldKeys.EXCEPTION_CLASS_KEY)
