...
def balanced_from_2_arrays_old(
        array_variables_staying,
        array_variables_adding_axes,
        axis_samples,
        axis_variables_table,
    ...
    # 2) the shapes of the two arrays must be equal, except for the axis_variable_table,
    #    i.e. the axis that contains the variables of the tables;
    # 3) axes_inserting cannot contain same values;
    # 4) shapes of axes_inserting and variables_table_adding_axes must be equal
    # 5) axis_samples != axis_variables_table
    # 6) the numbers of samples (or trials) in the axis_samples for all combinations
    #    of variables_table_adding_axes are equal
...
def from_2_arrays_flexible(
    ...
    #    i.e. the axis that contains the variables of the tables;
    # 3) axes_inserting cannot contain same values;
    # 4) variables_table_adding_axes cannot contain same values;
