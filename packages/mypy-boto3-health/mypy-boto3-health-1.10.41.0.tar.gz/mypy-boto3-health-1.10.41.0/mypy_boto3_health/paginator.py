...
class DescribeAffectedEntitiesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeAffectedEntities.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/health.html#Health.Paginator.DescribeAffectedEntities.paginate)
        """
...
class DescribeEventAggregatesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeEventAggregates.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/health.html#Health.Paginator.DescribeEventAggregates.paginate)
        """
...
class DescribeEventTypesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeEventTypes.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/health.html#Health.Paginator.DescribeEventTypes.paginate)
        """
...
class DescribeEventsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeEvents.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/health.html#Health.Paginator.DescribeEvents.paginate)
        """
