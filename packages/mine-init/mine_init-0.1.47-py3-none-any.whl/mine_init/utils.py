...
JAVA_PARAMS = {
    ...
    'debug_mode': os.getenv('MINECRAFT_DEBUG', None),
    'debug_log4_xml': os.getenv(
        'MINECRAFT_LOG4J_CONF',
        os.path.join(os.path.dirname(os.path.realpath(__file__)), 'extra_files/log_debug.xml')
    )
}
...
class JavaRunner:
    ...
    def start_jvm(self):
        ...
        if JAVA_PARAMS.get('debug_mode'):
            log_opts = '-Dlog4j.configurationFile=' + JAVA_PARAMS.get('debug_log4_xml')
