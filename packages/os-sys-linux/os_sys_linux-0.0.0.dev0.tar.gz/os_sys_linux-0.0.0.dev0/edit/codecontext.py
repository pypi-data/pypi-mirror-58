...
of each edit edit window which provides block structure hints.  These hints are
...
class CodeContext:
    ...
    def reload(cls):
        ...
        cls.context_depth = editConf.GetOption("extensions", "CodeContext",
...
if __name__ == "__main__":
    ...
    main('edit.edit_test.test_codecontext', verbosity=2, exit=False)
