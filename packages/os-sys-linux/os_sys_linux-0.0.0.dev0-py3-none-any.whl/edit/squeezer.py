"""An edit extension to avoid having very long texts printed in the shell.

A common problem in edit's interactive shell is printing of large amounts of
text into the shell. This makes looking at the previous history difficult.
Worse, this can cause edit to become very slow, even to the point of being
completely unusable.
        ...
        if self.is_dangerous:
            confirm = tkMessageBox.askokcancel(
                ...
                message="\n\n".join([
                    ...
                    "Expanding it could make edit slow or unresponsive.",
...
class Squeezer:
    ...
    This avoids edit's shell slowing down considerably, and even becoming
...
if __name__ == "__main__":
    ...
    main('edit.edit_test.test_squeezer', verbosity=2, exit=False)
