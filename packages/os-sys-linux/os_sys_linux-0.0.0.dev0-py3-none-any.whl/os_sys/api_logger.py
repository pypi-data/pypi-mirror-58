...
class GUI_APLOCATION(threading.Thread):
        ...
        if self.do_mainloop == True:
            ...
            while True:
                ...
                try:
                    ...
                    print('updated:',file=sys.stderr,flush=True)
                    print(new["updated"],flush=True)
                    print('msg:',file=sys.stderr,flush=True)
                    print(new["msg"],flush=True)
                    print('kwargs:',file=sys.stderr,flush=True)
                    print(new["kwargs"])
                    if self.isset(new,"updated"):
                        updated = True
                        self.up_kwargs = new["kwargs"]
                        self.up_msg = new["msg"]
    ...
    def print(self, *msg,**kwargs):
        if self.do_thread:
            ...
            dat = {'updated': True,"msg":msg,"kwargs":kwargs}
            print(dat)
            api.put(dat)
