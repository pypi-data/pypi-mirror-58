...
class ExploreApi(object):
    ...
    def search_with_http_info(self, collection, **kwargs):
        ...
        all_params = ['collection', 'f', 'q', 'pwithin', 'gwithin', 'gintersect', 'notpwithin', 'notgwithin', 'notgintersect', 'dateformat', 'column_filter', 'pretty', 'flat', 'include', 'exclude', 'size', '_from', 'sort', 'after', 'before', 'max_age_cache']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'column_filter' in params:
            header_params['Column-Filter'] = params['column_filter']
