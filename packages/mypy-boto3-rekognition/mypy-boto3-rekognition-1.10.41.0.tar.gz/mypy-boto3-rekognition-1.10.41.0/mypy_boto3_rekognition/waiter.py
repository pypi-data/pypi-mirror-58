...
class ProjectVersionRunningWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [ProjectVersionRunning.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/rekognition.html#Rekognition.Waiter.ProjectVersionRunning.wait)
        """
...
class ProjectVersionTrainingCompletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [ProjectVersionTrainingCompleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.41/reference/services/rekognition.html#Rekognition.Waiter.ProjectVersionTrainingCompleted.wait)
        """
