...
public:
    ...
    public:
        ...
        void OnRewarded(admob::rewarded_video::RewardItem reward) override {
            ...
            m_HandlerFunc("Admob", "RewardedVideo", reward.amount, reward.reward_type.c_str());
        }
        void OnPresentationStateChanged(
                admob::rewarded_video::PresentationState state) override {
            LOG("Rewarded video PresentationState has changed to %d.", state);
            m_HandlerFunc("Admob", "RewardedVideo", state, "PresentationStateChanged");
    ...
    public:
        ...
        void OnPresentationStateChanged(
            ...
            m_HandlerFunc("Admob", "Interstitial", state, "PresentationStateChanged");
    ...
    public:
        ...
        void OnPresentationStateChanged(
            ...
            m_HandlerFunc("Admob", "BannerView", state, "PresentationStateChanged");
        }
