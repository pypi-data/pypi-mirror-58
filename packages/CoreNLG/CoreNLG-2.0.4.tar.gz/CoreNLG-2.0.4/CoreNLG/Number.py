...
class Number:
    def __init__(self, short="", sep=".", mile_sep=" ", dec: int=None,
                 force_sign=False, remove_trailing_zeros=True, no_interpret=None):

        self.short = short
        self.sep = sep
        self.mile_sep = mile_sep
        self.dec = dec
    ...
    def nlg_num(self, num, short=None, sep=None, mile_sep=None, dec: int=None, force_sign=None, remove_trailing_zeros=None):
        _sign = ""
        ...
        return self.__no_interpret(
            _format.format(_sign, num, self.short).replace(",", self.mile_sep).replace(".", self.sep)
        )


def nlg_num(num, short=None, sep=None, mile_sep=None, dec: int=None, force_sign=None, remove_trailing_zeros=None):
