...
if __name__ == '__main__':
    ...
    clear_all = False  # 每次执行后是否删除创建的文件和文件夹

    CreateRandomFiles(base_path, turns, files_num, file_size_max, file_size_min, clear_flag=clear_all)
