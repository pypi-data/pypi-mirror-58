...
def stepinfo(signal, settling_time_threshold=0.02, rise_time_thresholds=(0.1, 0.9), ss_during=None, initial_value_override=None, final_value_override=None):
    """
    ...
    """
    return _impl.stepinfo(signal, settling_time_threshold, rise_time_thresholds, ss_during, initial_value_override, final_value_override)
