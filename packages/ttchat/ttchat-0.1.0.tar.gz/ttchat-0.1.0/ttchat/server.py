...
class Server(object):
    def __init__(self, port=2006, allow_saved_usernames: bool=True, log_ips: bool=False, saved_usernames_file: str="ttchat_saved_usernames.json", log_file: str="ip_logs.txt"):
        # Globals
        global saved_usernames
