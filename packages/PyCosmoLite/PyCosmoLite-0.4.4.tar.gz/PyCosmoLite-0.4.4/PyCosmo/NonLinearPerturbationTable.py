...
class NonLinearPerturbationTable(NonLinearPerturbationBase):
    ...
    def _enrich_params(self):
        ...
        :param _interpolation_params: dictionary containing the interpolation parameters for pk
                                      nonlin as a function of k (or None)
        :return: None
        """
        ...
        calc = dict(dim=2, gridtype='log', nx=agridsize, ny=kgridsize, adaptive=False,
                    tol=1e-3)
