...
# cryptosyspki.py
# $Date: 2019-12-27 13:43:00 $

# ************************** LICENSE *****************************************
# Copyright (C) 2016-19 David Ireland, DI Management Services Pty Limited.
...
class Cipher:
    ...
    @staticmethod
    def encrypt(data, key, iv=None, algmodepad='', alg=None, mode=Mode.ECB, pad=Pad.DEFAULT):
        """Encrypt data.
    ...
    @staticmethod
    def decrypt(data, key, iv=None, algmodepad='', alg=None, mode=Mode.ECB, pad=Pad.DEFAULT):
        """Decrypt data.
