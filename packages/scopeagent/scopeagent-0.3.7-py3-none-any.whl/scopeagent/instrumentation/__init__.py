...
ALL_LIBRARIES = {'server_django', 'server_flask', 'client_requests', 'client_urllib_request', 'client_kombu',
                 'app_celery', 'testing_unittest', 'testing_pytest', 'logging_logging', 'db_psycopg2'}
