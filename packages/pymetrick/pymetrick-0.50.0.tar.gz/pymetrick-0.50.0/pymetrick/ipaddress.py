...
if __name__ == "__main__":
    ...
    print (ip_address("192.0.2.128"))
    addr = ip_address("192.0.2.128")
    print (addr)
    print (addr.version)
    addr = ip_address('::ffff:%s' % "192.0.2.128")
    print (addr)
    print (addr.version)

    ip = ["2a01:4f8:171:274f::2","2607:f298:0006:a044::412:43fa","2001:0db8:85a3::8a2e:0370:7334","::ffff:192.0.2.128","::ffff:c000:280"]
    print ( ipv6to4("::ffff:c000:280"))
    q = _BaseV4(None)
    print (q._ip_int_from_string("192.0.2.128"))
    ...
    for n in ip:
        #print (ipv6to4(n))
        print (n)
        h = p._ip_int_from_string(n)
        print (h)
        j = p._string_from_ip_int(h)
        print (j)
