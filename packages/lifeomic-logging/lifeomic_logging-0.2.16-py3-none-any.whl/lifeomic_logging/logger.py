...
from logging import Formatter, Filter, StreamHandler, getLogger, INFO, getLevelName
...
class LoggingContextFilter(Filter):
    ...
    def filter(self, record):
        ...
        [log_context.pop(key, None) for key in RESERVED_ATTRS]
...
class JSONFormatter(Formatter):
    def _getjsondata(self, record):
        ...
        fields.append(("severity2", record.__dict__.get('levelname', 'DEBUG')))
        fields.append(("level",  record.__dict__.get('levelno', 10)))
