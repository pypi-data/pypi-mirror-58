...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', 'v1.4.0-alpha.1578306404+gb0d27be'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul v1.4.0-alpha.1578306404+gb0d27be`
                """)
            else:
                raise
