...
_CATEGORICALCROSSSTATISTICS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='lift_series', full_name='tensorflow.metadata.v0.CategoricalCrossStatistics.lift_series', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LIFTSERIES_LIFTVALUE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='x_and_y_count', full_name='tensorflow.metadata.v0.LiftSeries.LiftValue.x_and_y_count', index=4,
...
_LIFTSERIES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lift_values', full_name='tensorflow.metadata.v0.LiftSeries.lift_values', index=4,
      number=5, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CATEGORICALCROSSSTATISTICS.fields_by_name['lift_series'].message_type = _LIFTSERIES
...
CategoricalCrossStatistics = _reflection.GeneratedProtocolMessageType('CategoricalCrossStatistics', (_message.Message,), dict(
...
LiftSeries = _reflection.GeneratedProtocolMessageType('LiftSeries', (_message.Message,), dict(
  ...
  LiftValue = _reflection.GeneratedProtocolMessageType('LiftValue', (_message.Message,), dict(
