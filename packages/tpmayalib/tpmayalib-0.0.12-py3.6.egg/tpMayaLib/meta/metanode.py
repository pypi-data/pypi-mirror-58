...
class MetaNode(object):
    ...
    def __init__(self, node=None, name=None, name_args=None, name_kwargs=None, node_type='network', *args, **kwargs):
        ...
        if not node:
            ...
            self.add_attribute('meta_class', value=str(self.__class__.__name__), attr_type='string')        # MetaNode class
            self.add_attribute('meta_class_group', value='MetaClass', attr_type='string', hidden=True)      # Use to identify system base classes
            self.add_attribute('meta_system_root', value=False, attr_type='bool', hidden=True)              # Indicates this node if a system root MetaNode
...
# # We force the update of the meta classes register
