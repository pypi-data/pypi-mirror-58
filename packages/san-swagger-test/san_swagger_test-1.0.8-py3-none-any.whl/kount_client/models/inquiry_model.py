...
from kount_client.models.billing_address_with_premise import BillingAddressWithPremise  # noqa: F401,E501
from kount_client.models.shipping_address import ShippingAddress  # noqa: F401,E501
from kount_client.models.shipping_address_with_premise import ShippingAddressWithPremise  # noqa: F401,E501
...
class InquiryModel(object):
    ...
    swagger_types = {
        ...
        'billing_address_with_premise': 'list[BillingAddressWithPremise]',
        'shipping_address': 'list[ShippingAddress]',
        'shipping_address_with_premise': 'list[ShippingAddressWithPremise]',
    ...
    def __init__(self, card_no=None, total=None, ip_address=None, email=None, session_id=None, mack=None, product_type=None, product_item=None, product_description=None, product_quantity=None, product_price=None, anid=None, mode=None, customer_id=None, date_of_birth=None, gender=None, currency=None, sdk_version=None, user_agent=None, name=None, unique=None, set_epoch=None, cash=None, ship_type=None, billing_phone_number=None, shipping_phone_number=None, shipping_name=None, shipping_email=None, website=None, cart=None, billing_address=None, billing_address_with_premise=None, shipping_address=None, shipping_address_with_premise=None, user_defined_field=None):  # noqa: E501
        ...
        self._billing_address_with_premise = None
        self._shipping_address = None
        self._shipping_address_with_premise = None
        ...
        if billing_address_with_premise is not None:
            self.billing_address_with_premise = billing_address_with_premise
        if shipping_address is not None:
            self.shipping_address = shipping_address
        if shipping_address_with_premise is not None:
            self.shipping_address_with_premise = shipping_address_with_premise
    ...
    @property
    def billing_address_with_premise(self):
        """Gets the billing_address_with_premise of this InquiryModel.  # noqa: E501


        :return: The billing_address_with_premise of this InquiryModel.  # noqa: E501
        :rtype: list[BillingAddressWithPremise]
        """
        return self._billing_address_with_premise

    @billing_address_with_premise.setter
    def billing_address_with_premise(self, billing_address_with_premise):
        """Sets the billing_address_with_premise of this InquiryModel.


        :param billing_address_with_premise: The billing_address_with_premise of this InquiryModel.  # noqa: E501
        :type: list[BillingAddressWithPremise]
        """

        self._billing_address_with_premise = billing_address_with_premise
    ...
    @property
    def shipping_address_with_premise(self):
        """Gets the shipping_address_with_premise of this InquiryModel.  # noqa: E501


        :return: The shipping_address_with_premise of this InquiryModel.  # noqa: E501
        :rtype: list[ShippingAddressWithPremise]
        """
        return self._shipping_address_with_premise

    @shipping_address_with_premise.setter
    def shipping_address_with_premise(self, shipping_address_with_premise):
        """Sets the shipping_address_with_premise of this InquiryModel.


        :param shipping_address_with_premise: The shipping_address_with_premise of this InquiryModel.  # noqa: E501
        :type: list[ShippingAddressWithPremise]
        """

        self._shipping_address_with_premise = shipping_address_with_premise
