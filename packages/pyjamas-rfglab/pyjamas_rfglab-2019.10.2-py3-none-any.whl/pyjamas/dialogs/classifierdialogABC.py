...
class ClassifierDialogABC(ABC):
    ...
    step_sz: Tuple[int, int] = rimnn.nnmlp.DEFAULT_STEP_SZ
    ...
    def _open_positive_folder_dialog(self) -> bool:
        folder = rutils.RUtils.open_folder_dialog("Negative training folder", ClassifierDialogABC.positive_training_folder)
    ...
    def _open_hard_folder_dialog(self) -> bool:
        folder = rutils.RUtils.open_folder_dialog("Negative training folder", ClassifierDialogABC.hard_negative_training_folder)
