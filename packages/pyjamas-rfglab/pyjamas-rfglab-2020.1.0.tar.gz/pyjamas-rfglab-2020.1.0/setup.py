...
setuptools.setup(
    ...
    install_requires=["lxml>=4.2.5", "matplotlib>=3.0.0,<=3.0.1", "networkx==2.1", "numpy>=1.16.0,<2.0", "opencv_python>=3.4.5.20",
                      "pandas>=0.23.4", "PyQt5>=5.13.1", "scikit-image>=0.14.1", "scikit-learn>=0.21.2",
