...
vspec = importlib.util.spec_from_file_location(
  "version",
  str(Path(__file__).resolve().parent / 'bnrml' / "version.py")
)
...
setup(
    name='bnrml',
    description="Be normal! (It's a string normalization framework.)",
    ...
    install_requires=[
        ...
        # 'measurement>=1.8.0,<2'
        'click>=7.0,<8',
        'frozenordereddict>=1.2.0,<2',
        'phonetics>=1.0.5,<2',
        'pytypewriter>=0.0.7,<0.1',
        'textdistance>=4.1.4,<5',
        'toml'
    ],
    entry_points="""
    [console_scripts]
    ...
    url='https://github.com/patdaburu/bnrml',
    download_url=(
        f'https://github.com/patdaburu/'
        f'bnrml/archive/{version}.tar.gz'
    ),
    keywords=[
