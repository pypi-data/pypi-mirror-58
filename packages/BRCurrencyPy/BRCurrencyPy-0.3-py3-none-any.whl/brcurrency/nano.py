...
class Nano():
  def __init__(self):
    ...
    """
    req = requests.get('https://dolarhoje.com/nano-hoje/')
  ...
  def get_cotacao(self):
    """
    Retorna a cotação atual do Nano em https://dolarhoje.com/nano-hoje/ .
    Exemplo: 4.33
    """
  ...
  def get_cotacao_str(self):
    """"
    Retorna a cotação atual do Nano em String e adiciona formatação.
    Exemplo: R$514,48
    """
  ...
  def converter(self, value: float):
    """
    Converte :value: de Nano para real.
    NANO -> R$
    """
  ...
  def converter_str(self, value:float):
    """
    Converte :value: de Nano para real em String e adiciona formatação.
    NANO -> R$
    """
