...
class MyTest(unittest.TestCase):
    ...
    def testComputeLinearInstances(self):
        ...
        timeMeasureLinearA = measuresDefinitionAux.auxiliarLinearTimeMeasure('lifecycle_transition == "In Progress"', 'lifecycle_transition == "Awaiting Assignment"', True)
    ...
    def testComputeLinearInstancesWithSeveralFrom(self):
        ...
        timeMeasureLinearA = measuresDefinitionAux.auxiliarLinearTimeMeasure('lifecycle_transition == "In Progress"', 'lifecycle_transition == "Awaiting Assignment"', False)
    ...
    def testComputeCyclicSumInstances(self):
        ...
        timeMeasureCyclic = measuresDefinitionAux.auxiliarCyclicTimeMeasure('lifecycle_transition == "In Progress"', 'lifecycle_transition == "Awaiting Assignment"', 'SUM')
    ...
    def testComputeCyclicMaxInstances(self):
        ...
        timeMeasureCyclic = measuresDefinitionAux.auxiliarCyclicTimeMeasure('lifecycle_transition == "In Progress"', 'lifecycle_transition == "Awaiting Assignment"', 'MAX')
    ...
    def testComputeCyclicAvgInstances(self):
        ...
        timeMeasureCyclic = measuresDefinitionAux.auxiliarCyclicTimeMeasure('lifecycle_transition == "In Progress"', 'lifecycle_transition == "Awaiting Assignment"', 'AVG')
