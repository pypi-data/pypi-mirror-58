...
class TreeAuditModelQuerySet(AuditQuerySet):
    def _check(self, **kwargs):
        if kwargs.get('parent'):
            if kwargs.get('parent').id == kwargs.get('child').id:
                raise Exception(f'Attempt to write circular reference id ({kwargs.get("parent").id})')
    ...
    def get_descendants(self, id=None, start=None, end=None, child_id='child_id', parent_id='parent_id', include_self=True, where_clause='', order_by_clause='', fields='*') -> RawQuerySet:
...
class TreeAuditModelManager(AuditManager):
    ...
    def get_descendants(self, id=None, limit=None, child_id='child_id', parent_id='parent_id', include_self=True, where_clause='', order_by_clause='', fields='*') -> RawQuerySet:
        return self.get_queryset().get_descendants(id=id, end=limit, child_id=child_id, parent_id=parent_id, include_self=include_self, where_clause=where_clause, order_by_clause=order_by_clause, fields=fields)

    def get_parents(self, id=None, limit=None, child_id='child_id', parent_id='parent_id', include_self=True, where_clause='', order_by_clause='', fields='*') -> RawQuerySet:
        return self.get_queryset().get_parents(id=id, end=limit, child_id=child_id, parent_id=parent_id, include_self=include_self, where_clause=where_clause, order_by_clause=order_by_clause, fields=fields)

    def get_descendants_count(self, id=None, limit=None, child_id='child_id', parent_id='parent_id', include_self=True, where_clause='') -> int:
