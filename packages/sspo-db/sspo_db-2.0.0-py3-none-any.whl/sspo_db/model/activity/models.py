...
association_sprint_scrum_development_table = Table('association_sprint_scrum_development', Base.metadata,
...
association_sprint_backlog_scrum_development_table = Table('association_sprint_backlog_scrum_development', Base.metadata,
    Column('scrum_development_task_id', Integer, ForeignKey('scrum_development_task.id')),
...
class ScrumDevelopmentTask(Entity):
    ...
    sprints = relationship("Sprint", secondary=association_sprint_scrum_development_table, back_populates="scrum_development_tasks")
    sprint_backlogs = relationship("SprintBacklog", secondary=association_sprint_backlog_scrum_development_table, back_populates="scrum_development_tasks")
